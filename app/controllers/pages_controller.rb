class PagesController < ApplicationController
  ...
  def env
    @passenger_version = `/usr/bin/passenger-config --version`.scan(/\d+\.\d+\.\d+/).first if Rails.env.production?
    ...
    @puma_version = Puma::Const::VERSION unless Rails.env.production?
