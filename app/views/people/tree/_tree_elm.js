...
Elm.Box.make = function (_elm) {
   ...
   var couple = F3(function (picture,
   p1,
   p2) {
      return function () {
         var b2 = A3(box,
                 ...
                 var b = function () {
                    ...
                    {case "_Tuple2":
                       switch (_v16._0.ctor)
                         {case "Just":
                            switch (_v16._1.ctor)
                              {case "Just": return A3(couple,
                                   picture,
                                   _v16._0._0,
                                   _v16._1._0);
                                 case "Nothing": return A3(box,
                                   {ctor: "_Tuple2",_0: 0,_1: 1},
                                   picture,
                                   _v16._0._0);}
                              break;
...
Elm.Family.make = function (_elm) {
   ...
   var nobody = {_: {}
                ,id: 0
                ,name: "Initialising..."
                ,pictures: $Array.fromList(_L.fromArray([default_picture_path]))
                ,years: ""};
   var blur = {_: {}
              ...
              ,person: nobody};
   var picturePath = F2(function (picture,
   person) {
      return function () {
         var total = $Array.length(person.pictures);
         var index = _U.cmp(total,
         1) < 0 ? 0 : A2($Basics._op["%"],
         picture,
         total);
         return $Maybe.withDefault(default_picture_path)(A2($Array.get,
         index,
         person.pictures));
      }();
   });
   ...
   model) {
      return function () {
         ...
         {case "ChangeFocus":
            ...
            case "RolloverPictures":
            return _U.replace([["picture"
                               ,model.picture + 1]],
              model);
            case "Shift":
         ...
         var childrenBox = function () {
            ...
            {case "Just":
               return function () {
                    ...
                    return $Array.isEmpty(family._0.children) ? $Box.emptyBox : A4($Box.children,
                    handle,
                    bot,
                    model.picture,
                    family._0.children);
