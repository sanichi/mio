...
var _user$project$Config$defaultStyle = _evancz$elm_graphics$Text$defaultStyle;
var _user$project$Config$textStyle = _elm_lang$core$Native_Utils.update(
	_user$project$Config$defaultStyle,
	{
		typeface: _elm_lang$core$Native_List.fromArray(
			['Verdana', 'Helvetica', 'sans-serif']),
		height: _elm_lang$core$Maybe$Just(15),
		color: _elm_lang$core$Color$black
	});
var _user$project$Config$focusStyle = _elm_lang$core$Native_Utils.update(
	_user$project$Config$textStyle,
	{color: _elm_lang$core$Color$white});
var _user$project$Config$largeStyle = _elm_lang$core$Native_Utils.update(
	_user$project$Config$textStyle,
	{
		height: _elm_lang$core$Maybe$Just(40)
	});
var _user$project$Config$smallStyle = _elm_lang$core$Native_Utils.update(
	_user$project$Config$textStyle,
	{
		height: _elm_lang$core$Maybe$Just(11)
	});
var _user$project$Config$smallFocusStyle = _elm_lang$core$Native_Utils.update(
	_user$project$Config$smallStyle,
	{color: _elm_lang$core$Color$white});
var _user$project$Config$thumbSize = 100;
var _user$project$Config$padding = {x: 4, y: 4};
var _user$project$Config$margin = {x: 18, y: 18};
var _user$project$Config$initialWidth = 500;
var _user$project$Config$deltaShift = 200;
var _user$project$Config$boxHeight = function () {
	var combined = 'x';
	var year = A2(
		_evancz$elm_graphics$Text$style,
		_user$project$Config$smallStyle,
		_evancz$elm_graphics$Text$fromString('2000'));
	var name = A2(
		_evancz$elm_graphics$Text$style,
		_user$project$Config$textStyle,
...
var _user$project$Config$initialHeight = 3 * _user$project$Config$levelHeight;
var _user$project$Config$border = 1;

var _user$project$Types$defaultPicturePath = '/images/blank_woman.png';
var _user$project$Types$picturePath = F2(
	function (picture, person) {
		...
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Types$defaultPicturePath,
			A2(_elm_lang$core$Array$get, index, person.pictures));
	});
var _user$project$Types$initModel = function (flags) {
	return {width: _user$project$Config$initialWidth, height: _user$project$Config$initialHeight, focus: flags.focus};
};
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {width: a, height: b, focus: c};
	});
