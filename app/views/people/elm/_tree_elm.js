...
var _user$project$Config$pointerFontHeight = 30;
var _user$project$Config$fontWidthToHeight = function (width) {
	return ((width * 6) / 10) | 0;
};
var _user$project$Config$pointerFontWidth = _user$project$Config$fontWidthToHeight(_user$project$Config$pointerFontHeight);
var _user$project$Config$smallFontWidth = _user$project$Config$fontWidthToHeight(_user$project$Config$smallFontHeight);
...
var _user$project$Config$fontWidth = _user$project$Config$fontWidthToHeight(_user$project$Config$fontHeight);
...
var _user$project$Config$deltaShift = 100;
var _user$project$Config$defaultCenter = ((_user$project$Config$width / 2) | 0) - 100;
...
var _user$project$Config$viewBox = A2(
	...
	' ',
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Basics$toString(_user$project$Config$width),
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Basics$toString(_user$project$Config$height),
				_1: {ctor: '[]'}
			}
		}
	});

var _user$project$Types$initModel = function (flags) {
	return {focus: flags.focus, family: 0, picture: 0, shift: 0};
};
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {focus: a, family: b, picture: c, shift: d};
	});
var _user$project$Types$Person = F4(
	function (a, b, c, d) {
		return {id: a, name: b, years: c, pictures: d};
	});
var _user$project$Types$Family = F2(
	function (a, b) {
...
var _user$project$Messages$ShiftRight = {ctor: 'ShiftRight'};
var _user$project$Messages$ShiftLeft = {ctor: 'ShiftLeft'};
																...
																return A2(
																	...
																	function (name) {
																		return A2(
																			...
																			A2(_elm_lang$core$Json_Decode$field, 'years', _elm_lang$core$Json_Decode$string));
																	},
...
var _user$project$Tree$shiftPoint = F2(
	function (deltaX, point) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Tuple$first(point) + deltaX,
			_1: _elm_lang$core$Tuple$second(point)
		};
	});
...
var _user$project$Tree$middleBox = function (bx) {
	return _elm_lang$core$Tuple$first(bx.top.inner);
};
var _user$project$Tree$handleToLink = function (handle) {
	var j2 = _elm_lang$core$Basics$toString(
		_elm_lang$core$Tuple$second(handle.outer));
	var i2 = _elm_lang$core$Basics$toString(
		_elm_lang$core$Tuple$first(handle.outer));
	var j1 = _elm_lang$core$Basics$toString(
		_elm_lang$core$Tuple$second(handle.inner));
	var i1 = _elm_lang$core$Basics$toString(
		_elm_lang$core$Tuple$first(handle.inner));
	return A2(
		_elm_lang$svg$Svg$line,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x1(i1),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y1(j1),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x2(i2),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y2(j2),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Tree$boxWidth = function (bx) {
	return _elm_lang$core$Tuple$first(bx.right.outer) - _elm_lang$core$Tuple$first(bx.left.outer);
};
var _user$project$Tree$linkO = F2(
	function (boxes, point) {
		...
		var vertical = function () {
			...
			if (_p1.ctor === 'Just') {
				var j2 = _elm_lang$core$Basics$toString(
					_elm_lang$core$Tuple$second(_p1._0.top.outer));
				var i2 = _elm_lang$core$Basics$toString(
		...
		var horizontal = function () {
			...
			if (((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) && (_p2._1.ctor === 'Just')) {
				...
				var _p3 = _p2._0._0;
				var j2 = _elm_lang$core$Basics$toString(
					_elm_lang$core$Tuple$second(_p4.top.outer));
				var i2 = _elm_lang$core$Basics$toString(
					_elm_lang$core$Tuple$first(_p4.top.outer));
				var j1 = _elm_lang$core$Basics$toString(
					_elm_lang$core$Tuple$second(_p3.top.outer));
				var i1 = _elm_lang$core$Basics$toString(
					_elm_lang$core$Tuple$first(_p3.top.outer));
				return _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$svg$Svg$line,
						{
...
var _user$project$Tree$linkM = F2(
	function (bx1, bx2) {
		var j2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$second(bx2.left.inner));
		var i2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$first(bx2.left.inner));
		var j1 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$second(bx1.right.inner));
		var i1 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$first(bx1.right.inner));
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$line,
...
var _user$project$Tree$linkH = F2(
	function (bx1, mbx2) {
		...
		if (_p6.ctor === 'Nothing') {
			...
			var _p7 = _p6._0;
			var j2 = _elm_lang$core$Basics$toString(
				_elm_lang$core$Tuple$second(_p7.top.outer));
			var i2 = _elm_lang$core$Basics$toString(
				_elm_lang$core$Tuple$first(_p7.top.outer));
			var j1 = _elm_lang$core$Basics$toString(
				_elm_lang$core$Tuple$second(bx1.top.outer));
			var i1 = _elm_lang$core$Basics$toString(
				_elm_lang$core$Tuple$first(bx1.top.outer));
			return {
				ctor: '::',
				_0: A2(
					_elm_lang$svg$Svg$line,
...
var _user$project$Tree$linkT = F3(
	function (left, right, below) {
		var by2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$second(below.top.inner));
		var bx2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$first(below.top.inner));
		var by1 = _elm_lang$core$Basics$toString(
			((_elm_lang$core$Tuple$second(left.right.outer) + _elm_lang$core$Tuple$second(right.left.outer)) / 2) | 0);
		var bx1 = _elm_lang$core$Basics$toString(
			((_elm_lang$core$Tuple$first(left.right.outer) + _elm_lang$core$Tuple$first(right.left.outer)) / 2) | 0);
		var ay2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$second(right.left.inner));
		var ax2 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$first(right.left.inner));
		var ay1 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$second(left.right.inner));
		var ax1 = _elm_lang$core$Basics$toString(
			_elm_lang$core$Tuple$first(left.right.inner));
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$line,
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$x1(ax1),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$y1(ay1),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x2(ax2),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y2(ay2),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x1(bx2),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y1(by1),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x2(bx2),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$y2(by2),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Tree$pointerAttrs = F4(
	function (c, i, j, handler) {
		return {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$class(c),
			_1: {
				ctor: '::',
...
var _user$project$Tree$pointers = function (boxes) {
	var rightPointer = function () {
		var h = _elm_lang$svg$Svg_Events$onClick(_user$project$Messages$ShiftRight);
		var j = _user$project$Config$pointerFontHeight;
		var i = _user$project$Config$width - _user$project$Config$pointerFontWidth;
		return A2(
			_elm_lang$svg$Svg$text_,
			A4(_user$project$Tree$pointerAttrs, 'pointer', i, j, h),
			{
				ctor: '::',
	...
	var leftPointer = function () {
		var h = _elm_lang$svg$Svg_Events$onClick(_user$project$Messages$ShiftLeft);
		var j = _user$project$Config$pointerFontHeight;
		var i = _user$project$Config$pointerFontWidth;
		return A2(
			_elm_lang$svg$Svg$text_,
			A4(_user$project$Tree$pointerAttrs, 'pointer', i, j, h),
			{
	...
	var rightMost = A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Config$width,
		_elm_lang$core$List$maximum(
			A2(
				_elm_lang$core$List$map,
				function (b) {
					return _elm_lang$core$Tuple$first(b.right.outer);
				},
				boxes)));
	var leftMost = A2(
		_elm_lang$core$Maybe$withDefault,
		...
		_elm_lang$core$List$minimum(
			A2(
				_elm_lang$core$List$map,
				function (b) {
					return _elm_lang$core$Tuple$first(b.left.outer);
				},
				boxes)));
	var _p8 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.cmp(leftMost, 0) < 0,
		_1: _elm_lang$core$Native_Utils.cmp(rightMost, _user$project$Config$width) > 0
	};
	if (_p8._0 === true) {
		if (_p8._1 === true) {
			return {
...
var _user$project$Tree$imageAttrs = F6(
	function (l, i, j, w, h, handler) {
		return {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$xlinkHref(l),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x(
					_elm_lang$core$Basics$toString(i)),
		...
		return {
			svgs: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$transform(transformX),
						_1: {ctor: '[]'}
					},
					bx.svgs),
				_1: {ctor: '[]'}
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg$text(years),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$Tree$parentBoxes = F4(
	function (focusBox, father, mother, picture) {
		...
		var leftFatherBox = A2(
			...
			center - _elm_lang$core$Tuple$first(fatherBox.right.outer),
			fatherBox);
		var rightMotherBox = A2(
			_user$project$Tree$shiftBox,
			center - _elm_lang$core$Tuple$first(motherBox.left.outer),
			motherBox);
		...
		if (_p11.ctor === 'Nothing') {
			...
			var switchWidth = function () {
				...
				if (_p12.ctor === 'Nothing') {
					...
					return _user$project$Tree$boxWidth(_p12._0);
				}
			}();
			...
			var shiftedSwitchBox = function () {
				...
				if (_p14.ctor === 'Nothing') {
					...
					return _elm_lang$core$Maybe$Just(
						A2(_user$project$Tree$shiftBox, switchShift, _p14._0));
				}
			}();
			var boxes = function () {
			...
			var links = function () {
				...
				if (_p16.ctor === 'Nothing') {
					...
					return A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_user$project$Tree$linkM, focusBox, _p17),
						A2(_user$project$Tree$linkM, _p17, shiftedPartnerBox));
				}
			}();
			var parentPoint = function () {
				var _p18 = shiftedSwitchBox;
				if (_p18.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Tuple$first(_p19.top.inner),
						_1: _elm_lang$core$Tuple$second(_p19.top.inner) + _user$project$Config$switchBoxHeight
					};
				}
			}();
	...
	function (focusBox, families, index, picture, parentPoint) {
		...
		if (_p20.ctor === 'Nothing') {
			...
			if (_elm_lang$core$Array$isEmpty(people)) {
				...
				var center = _elm_lang$core$Tuple$first(parentPoint);
				var boxes = A2(
					_elm_lang$core$Array$map,
					function (p) {
...
var _user$project$Tree$tree = function (model) {
	var center = _user$project$Config$defaultCenter + model.shift;
	var focus = model.focus;
	var focusBox = A5(_user$project$Tree$box, focus.person, model.picture, center, 2, true);
	var _p21 = A4(_user$project$Tree$parentBoxes, focusBox, focus.father, focus.mother, model.picture);
	var fatherBox = _p21._0;
	var motherBox = _p21._1;
	var parentLinks = _p21._2;
	var _p22 = A4(_user$project$Tree$siblingBoxes, focusBox, focus.olderSiblings, model.picture, _elm_lang$core$Maybe$Nothing);
	var oSibBoxes = _p22._0;
	var oSibLinks = _p22._1;
	var _p23 = A4(_user$project$Tree$partnerBoxes, focusBox, focus.families, model.family, model.picture);
	var partBoxes = _p23._0;
	...
	var childBoxes = _p25._0;
	var childLinks = _p25._1;
	var allBoxes = A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
	...
	var boxSvgs = _elm_lang$core$List$concat(
		A2(
			...
			allBoxes));
	var pointerSvgs = _user$project$Tree$pointers(allBoxes);
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		boxSvgs,
		A2(_elm_lang$core$Basics_ops['++'], linkSvgs, pointerSvgs));
};
		...
		switch (_p0.ctor) {
			...
			case 'ShiftLeft':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{shift: model.shift + _user$project$Config$deltaShift}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShiftRight':
				return {
...
var _user$project$Main$view = function (model) {
	...
	var background = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$class('background'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width(
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$id('family-tree'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$version('1.1'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox(_user$project$Config$viewBox),
					_1: {ctor: '[]'}
				}
			}
		},
		{ctor: '::', _0: background, _1: tree});
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Ports$gotFocus(_user$project$Messages$GotFocus),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _user$project$Config$changePicture * _elm_lang$core$Time$second, _user$project$Messages$Tick),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (flags) {
			return {
				ctor: '_Tuple2',
				_0: _user$project$Types$initModel(flags),
				_1: _user$project$Main$initTasks
			};
		},
																				...
																				return A2(
																					...
																					function (pictures) {
																						return A2(
																							...
																							function (years) {
																								return _elm_lang$core$Json_Decode$succeed(
																									{id: id, name: name, pictures: pictures, years: years});
																							},
																							A2(_elm_lang$core$Json_Decode$field, 'years', _elm_lang$core$Json_Decode$string));
																					},
																					A2(
						...
						A2(
							...
							function (children) {
								return A2(
									...
									function (partner) {
										return _elm_lang$core$Json_Decode$succeed(
											{children: children, partner: partner});
									},
									A2(
										_elm_lang$core$Json_Decode$field,
										'partner',
