	...
	var rightMost = A2(
		...
		_elm_lang$core$List$maximum(
			A2(
				_elm_lang$core$List$map,
				function (b) {
					return _elm_lang$core$Basics$fst(b.right.outer);
				},
				boxes)));
	var leftMost = A2(
		_elm_lang$core$Maybe$withDefault,
		...
		_elm_lang$core$List$minimum(
			A2(
				_elm_lang$core$List$map,
				function (b) {
					return _elm_lang$core$Basics$fst(b.left.outer);
				},
				boxes)));
	var _p8 = {
		ctor: '_Tuple2',
		...
		if (_p11.ctor === 'Nothing') {
			...
			var parentPoint = function () {
				...
				if (_p18.ctor === 'Nothing') {
					...
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$fst(_p19.top.inner),
						_1: _elm_lang$core$Basics$snd(_p19.top.inner) + _user$project$Config$switchBoxHeight
					};
				}
			}();
			return {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Ports$gotFocus(_user$project$Messages$GotFocus),
				A2(_elm_lang$core$Time$every, _user$project$Config$changePicture * _elm_lang$core$Time$second, _user$project$Messages$Tick)
			]));
};
