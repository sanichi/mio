...
var _user$project$Ports$concludeAnswer = _elm_lang$core$Native_Platform.outgoingPort(
	'concludeAnswer',
	function (v) {
		return v;
	});
var _user$project$Ports$finishAnswer = _elm_lang$core$Native_Platform.incomingPort('finishAnswer', _elm_lang$core$Json_Decode$int);
...
var _user$project$Main$concludeAnswer = function (part) {
	return _user$project$Ports$concludeAnswer(part);
};
		...
		switch (_p4.ctor) {
			...
			default:
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$concludeAnswer(_p9),
						_1: {ctor: '[]'}
					});
		}
	});
...
var _user$project$Main$viewAnswer = F2(
	function (part, model) {
		...
		var display = function () {
			if (thinking) {
				return _elm_lang$html$Html$text('Thinking');
			} else {
				var _p10 = answer;
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Ports$finishAnswer(_user$project$Main$Finish),
					_1: {ctor: '[]'}
				}
			}
		});
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: A2(_user$project$Main$viewAnswer, 1, model),
													_1: {
														ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SelectDay":["Int"],"SelectYear":["Int"],"Start":["Int"],"Finish":["Int"],"NewData":["String"],"Answer":["Int"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
