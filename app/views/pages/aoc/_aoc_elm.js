...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bE: 'hidden', bA: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bE: 'mozHidden', bA: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bE: 'msHidden', bA: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bE: 'webkitHidden', bA: 'webkitvisibilitychange' }
		: { bE: 'hidden', bA: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a5: fragment, a6: host, ao: path, bj: port_, bn: protocol, bo: query};
	});
...
var $author$project$Main$newProblem = F2(
	function (year, day) {
		...
		var newDay = function () {
			if (!year2.$) {
				var y = year2.a;
				return A2($elm$core$List$member, day, y.J) ? day : A2(
					$elm$core$Maybe$withDefault,
					$author$project$Main$defaultDay,
					$elm$core$List$head(y.J));
			} else {
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a7: index, bH: match, be: number, bN: submatches};
	});
...
var $truqu$elm_md5$MD5$hex_ = F2(
	function (xs, acc) {
		...
		if ((((((((((((((((xs.b && xs.b.b) && xs.b.b.b) && xs.b.b.b.b) && xs.b.b.b.b.b) && xs.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && (!xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b)) {
			...
			return {R: a17, aC: b17, aD: c17, aF: d17};
		} else {
			return acc;
		}
	});
...
var $author$project$Y15D10$mapper = function (match) {
	var length = $elm$core$String$fromInt(
		$elm$core$String$length(match.bH));
	var _char = A2($elm$core$String$left, 1, match.bH);
...
var $author$project$Y15D13$happinesses = function (model) {
	var f = function (_v0) {
		var p1 = _v0.a;
		var p2 = _v0.b;
		return A3($author$project$Y15D13$pairValue, p1, p2, model.L);
	};
	return A2(
		$elm$core$List$map,
		function (pairs) {
...
var $author$project$Y15D13$initModel = {L: $elm$core$Dict$empty, A: $elm$core$Set$empty};
...
var $author$project$Y15D14$parseLine = F2(
	function (line, model) {
		...
		if ((((((((((matches.b && matches.a.b) && (!matches.a.a.$)) && matches.a.b.b) && (!matches.a.b.a.$)) && matches.a.b.b.b) && (!matches.a.b.b.a.$)) && matches.a.b.b.b.b) && (!matches.a.b.b.b.a.$)) && (!matches.a.b.b.b.b.b)) && (!matches.b.b)) {
			...
			var reindeer = {al: 0, bd: n1, aP: r2, ar: 0, aS: s2, ab: t2};
...
var $author$project$Y15D15$Ingredient = F6(
	function (name, capacity, durability, flavor, texture, calories) {
		return {aY: calories, aZ: capacity, a1: durability, a4: flavor, bd: name, bv: texture};
	});
...
var $author$project$Y15D19$count = F2(
	function (rgx, model) {
		return $elm$core$List$length(
			A2($elm$regex$Regex$find, rgx, model.M));
	});
	...
	while (true) {
		...
		if (!_v0.b) {
			...
			var matches = A2(
				...
				model.M);
			var replacements_ = A5($author$project$Y15D19$addToReplacements, matches, from, to, model.M, model.aq);
			var model_ = {M: model.M, aq: replacements_, aH: rules};
			var $temp$model = model_;
			model = $temp$model;
...
var $author$project$Y15D19$parse = function (input) {
	...
	return {M: molecule, aq: $elm$core$Set$empty, aH: rules};
};
...
var $author$project$Y15D21$Fighter = F5(
	function (hitp, damage, armor, cost, player) {
		return {aX: armor, aK: cost, a0: damage, aG: hitp, bi: player};
	});
...
var $author$project$Y15D21$fighterFromIndex = function (i) {
	...
	var armor = A2(
		...
		_List_fromArray(
			[0, 0, 0]),
		A2($elm$core$Array$get, i.R, $author$project$Y15D21$armors));
	var totals = A5(
		$elm$core$List$map4,
		F4(
			function (w, a, r1, r2) {
...
var $author$project$Y15D21$nextIndex = function (i) {
	return (i.D < 7) ? $elm$core$Maybe$Just(
		...
		_Utils_update(
			i,
			{C: i.C + 1, D: i.C + 2})) : ((i.R < 5) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{R: i.R + 1, C: 0, D: 1})) : ((i.aB < 4) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{R: 0, C: 0, D: 1, aB: i.aB + 1})) : $elm$core$Maybe$Nothing)));
};
...
var $author$project$Y15D25$search = F2(
	function (_v0, model) {
		...
		while (true) {
			var row = _v0.a;
			var col = _v0.b;
			if (_Utils_eq(row, model.Y) && _Utils_eq(col, model.S)) {
				return model;
			} else {
				var code_ = A2($elm$core$Basics$modBy, 33554393, model.ah * 252533);
				var _v1 = (model.Y > 1) ? _Utils_Tuple2(model.Y - 1, model.S + 1) : _Utils_Tuple2(model.S + 1, 1);
				var row_ = _v1.a;
				var col_ = _v1.b;
				var $temp$_v0 = _Utils_Tuple2(row, col),
					$temp$model = {ah: code_, S: col_, Y: row_};
				_v0 = $temp$_v0;
				model = $temp$model;
				continue search;
			}
...
var $author$project$Y15D25$start = {ah: 20151125, S: 1, Y: 1};
...
var $author$project$Y16D04$northPole = function (room) {
	var name = A3($author$project$Y16D04$decrypt, room.as, '', room.bd);
	return A2(
		$elm$regex$Regex$contains,
...
var $author$project$Y16D04$Room = F3(
	function (name, sector, checksum) {
		return {a$: checksum, bd: name, as: sector};
	});
...
var $author$project$Y16D15$Disc = F3(
	function (number, positions, position) {
		return {be: number, ap: position, aN: positions};
	});
var $author$project$Y16D15$invalid = {be: 0, ap: 0, aN: 1};
...
var $author$project$Y16D20$Block = F2(
	function (lower, upper) {
		return {W: lower, P: upper};
	});
var $author$project$Y16D20$merge = F2(
	function (b1, b2) {
		return (_Utils_cmp(b2.P, b1.P) < 1) ? b1 : A2($author$project$Y16D20$Block, b1.W, b2.P);
	});
var $author$project$Y16D20$mergeable = F2(
	function (b1, b2) {
		return _Utils_cmp(b2.W, b1.P + 1) < 1;
	});
...
var $author$project$Y16D22$Cluster = F3(
	function (width, height, nodes) {
		return {V: height, an: nodes, Q: width};
	});
	...
	function (cluster, nodes) {
		...
		while (true) {
			if (!nodes.b) {
				...
				var newWidth = (_Utils_cmp(node.F + 1, cluster.Q) > 0) ? (node.F + 1) : cluster.Q;
				var newNodes = A3(
					$elm$core$Dict$insert,
	...
	function (cluster, y) {
		return $elm$core$String$fromList(
			A2(
				...
				A2($elm$core$List$range, 0, (-1) + cluster.Q)));
	});
...
var $author$project$Y20D02$Password = F4(
	function (min, max, letter, password) {
		return {a9: letter, ba: max, bb: min, bg: password};
	});
var $author$project$Y20D02$parsePassword = function (submatches) {
	if ((((((((submatches.b && (!submatches.a.$)) && submatches.b.b) && (!submatches.b.a.$)) && submatches.b.b.b) && (!submatches.b.b.a.$)) && submatches.b.b.b.b) && (!submatches.b.b.b.a.$)) && (!submatches.b.b.b.b.b)) {
		...
		var min = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(min_));
		var max = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$String$toInt(max_));
		return $elm$core$Maybe$Just(
			A4($author$project$Y20D02$Password, min, max, letter, password));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Y20D02$parse = function (input) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$regex$Regex$find,
				$author$project$Util$regex('(\\d+)-(\\d+) ([a-z]): ([a-z]+)'),
				input)));
};
var $elm$core$String$indices = _String_indexes;
var $author$project$Y20D02$valid = function (p) {
	var count = $elm$core$List$length(
		A2($elm$core$String$indices, p.a9, p.bg));
	return (_Utils_cmp(p.bb, count) < 1) && (_Utils_cmp(p.ba, count) > -1);
};
var $author$project$Y20D02$answer = F2(
	function (part, input) {
		var passwords = $author$project$Y20D02$parse(input);
		var example = $author$project$Y20D02$parse('1-3 a: abcde 1-3 b: cdefg 2-9 c: ccccccccc');
		return (part === 1) ? $elm$core$String$fromInt(
			$elm$core$List$length(
				A2($elm$core$List$filter, $author$project$Y20D02$valid, passwords))) : $elm$core$String$fromInt(
			$elm$core$List$length(
				A2($elm$core$List$filter, $author$project$Y20D02$valid, example)));
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 3:
				var part = msg.a;
				var data = A2($elm$core$Maybe$withDefault, '', model.T);
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{bG: $author$project$Main$init, bO: $author$project$Main$subscriptions, bQ: $author$project$Main$update, bR: $author$project$Main$view});
