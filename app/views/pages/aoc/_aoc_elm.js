...
var _user$project$Main$newProblem = F3(
	function (year, day, model) {
		...
		var newDay = function () {
			...
			if (_p5.ctor === 'Just') {
				var _p6 = _p5._0;
				return A2(_elm_lang$core$List$member, day, _p6.days) ? day : A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Main$defaultDay,
					_elm_lang$core$List$head(_p6.days));
			} else {
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			case 'SelectYear':
				var _p8 = A3(_user$project$Main$newProblem, _p7._0, model.day, model);
				var newYear = _p8._0;
				var newDay = _p8._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'SelectDay':
				var _p9 = A3(_user$project$Main$newProblem, model.year, _p7._0, model);
				var newYear = _p9._0;
				var newDay = _p9._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'NewData':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							data: _elm_lang$core$Maybe$Just(_p7._0)
						}),
					{ctor: '[]'});
			case 'Prepare':
				var _p10 = _p7._0;
