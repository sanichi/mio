...
{
	if (region.b4.aA === region.bD.aA)
	{
		return 'on line ' + region.b4.aA;
	}
	return 'on lines ' + region.b4.aA + ' through ' + region.bD.aA;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bG: fragment, bH: host, aD: path, bS: port_, bW: protocol, bY: query};
	});
...
var $author$project$Main$defaultDay = 23;
...
var $author$project$Main$initModel = {
	aa: _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing),
	ad: '',
	b: $author$project$Main$defaultDay,
	aw: false,
	X: _Utils_Tuple2(false, false),
	a: $author$project$Main$defaultYear,
	ap: _List_fromArray(
		[
			{
			B: A2($elm$core$List$range, 1, 25),
			a: 2015
		},
			{
			B: A2($elm$core$List$range, 1, 25),
			...
			{
			B: A2($elm$core$List$range, 1, $author$project$Main$defaultDay),
			a: $author$project$Main$defaultYear
		}
		])
};
	...
	function (year, day) {
		var year1 = $elm$core$List$head(
			A2(
				...
				$author$project$Main$initModel.ap));
		...
		var newDay = function () {
			if (!year2.$) {
				var y = year2.a;
				return A2($elm$core$List$member, day, y.B) ? day : A2(
					$elm$core$Maybe$withDefault,
					$author$project$Main$defaultDay,
					$elm$core$List$head(y.B));
			} else {
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bJ: index, cn: match, bO: number, ct: submatches};
	});
	...
	function (model, instructions) {
		...
		while (true) {
			if ($elm$core$String$isEmpty(instructions)) {
				...
				var next = $elm$core$String$uncons(instructions);
				var index = model.aL % $elm$core$Array$length(model.aj);
				var santa = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Y15D03$errorSanta(
						'illegal index [' + ($elm$core$String$fromInt(index) + ']')),
					A2($elm$core$Array$get, index, model.aj));
				var _v0 = function () {
					if (!next.$) {
						var _v2 = next.a;
						var c = _v2.a;
				...
				if (santa_.aI) {
					...
					var model_ = _Utils_update(
						model,
						{
							aj: A3($elm$core$Array$set, index, santa_, model.aj),
							aL: model.aL + 1,
							aP: A3($author$project$Y15D03$visit, santa_.L, santa_.M, model.aP)
						});
...
var $author$project$Y15D03$initSanta = {D: $elm$core$Maybe$Nothing, aI: false, L: 0, M: 0};
...
var $author$project$Y15D03$initModel = function (n) {
	return {
		...
		aj: A2($elm$core$Array$repeat, n, $author$project$Y15D03$initSanta),
		aL: 0,
		aP: A3($author$project$Y15D03$visit, 0, 0, $elm$core$Dict$empty)
	};
};
...
var $truqu$elm_md5$MD5$hex_ = F2(
	function (xs, acc) {
		...
		if ((((((((((((((((xs.b && xs.b.b) && xs.b.b.b) && xs.b.b.b.b) && xs.b.b.b.b.b) && xs.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b) && (!xs.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b.b)) {
			...
			return {_: a17, aR: b17, aS: c17, aU: d17};
		} else {
			return acc;
		}
	});
...
var $author$project$Y15D09$extreme = function (model) {
	...
	return A2(
		...
		A2(
			...
			$author$project$Util$permutations(model.P)));
};
...
var $author$project$Y15D09$initModel = {P: _List_Nil, av: $elm$core$Dict$empty};
		...
		if ((((((((matches.b && matches.a.b) && (!matches.a.a.$)) && matches.a.b.b) && (!matches.a.b.a.$)) && matches.a.b.b.b) && (!matches.a.b.b.a.$)) && (!matches.a.b.b.b.b)) && (!matches.b.b)) {
			...
			var distances = A3(
				...
				A3(
					...
					di,
					model.av));
			var cities_ = A2($elm$core$List$member, c1, model.P) ? model.P : A2($elm$core$List$cons, c1, model.P);
			var cities = A2($elm$core$List$member, c2, cities_) ? cities_ : A2($elm$core$List$cons, c2, cities_);
			return _Utils_update(
				model,
				{P: cities, av: distances});
		} else {
			return model;
		}
	});
...
var $author$project$Y15D10$mapper = function (match) {
	var length = $elm$core$String$fromInt(
		$elm$core$String$length(match.cn));
	var _char = A2($elm$core$String$left, 1, match.cn);
...
var $author$project$Y15D13$addMe = function (model) {
	var me = 'Me';
	var p = A2($elm$core$Set$insert, me, model.G);
	var h0 = model.R;
	var a = $elm$core$Set$toList(model.G);
	var h1 = A3(
		$elm$core$List$foldl,
		F2(
			function (q, h) {
...
var $author$project$Y15D13$happinesses = function (model) {
	var f = function (_v0) {
		var p1 = _v0.a;
		var p2 = _v0.b;
		return A3($author$project$Y15D13$pairValue, p1, p2, model.R);
	};
	return A2(
		$elm$core$List$map,
		function (pairs) {
		...
		A2(
			...
			$author$project$Util$permutations(
				$elm$core$Set$toList(model.G))));
};
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $author$project$Y15D13$initModel = {R: $elm$core$Dict$empty, G: $elm$core$Set$empty};
	...
	function (line, model) {
		...
		if ((((((((((matches.b && matches.a.b) && (!matches.a.a.$)) && matches.a.b.b) && (!matches.a.b.a.$)) && matches.a.b.b.b) && (!matches.a.b.b.a.$)) && matches.a.b.b.b.b) && (!matches.a.b.b.b.a.$)) && (!matches.a.b.b.b.b.b)) && (!matches.b.b)) {
			...
			var p = A2(
				$elm$core$Set$insert,
				p2,
				A2($elm$core$Set$insert, p1, model.G));
			var j = A2(
				$elm$core$Maybe$withDefault,
				0,
				$elm$core$String$toInt(i));
...
var $author$project$Y15D14$distance = F2(
	function (t, r) {
		var cyc = r.al + r.bl;
		var tmp = t % cyc;
		var rdr = (_Utils_cmp(tmp, r.al) > 0) ? r.al : tmp;
		return ((((t / cyc) | 0) * r.al) + rdr) * r.bn;
	});
				...
				var model1 = A2(
					...
					function (r) {
						return _Utils_update(
							r,
							{
								az: A2($author$project$Y15D14$distance, t_, r)
							});
					},
					model);
				var maxDst = A2(
				...
				var model2 = A2(
					...
					function (r) {
						return _Utils_update(
							r,
							{
								aG: r.aG + (_Utils_eq(r.az, maxDst) ? 1 : 0)
							});
					},
					model1);
				var $temp$t = t_,
...
var $author$project$Y15D14$parseLine = F2(
	function (line, model) {
		...
		if ((((((((((matches.b && matches.a.b) && (!matches.a.a.$)) && matches.a.b.b) && (!matches.a.b.a.$)) && matches.a.b.b.b) && (!matches.a.b.b.a.$)) && matches.a.b.b.b.b) && (!matches.a.b.b.b.a.$)) && (!matches.a.b.b.b.b.b)) && (!matches.b.b)) {
			...
			var reindeer = {az: 0, bN: n1, bl: r2, aG: 0, bn: s2, al: t2};
...
var $author$project$Y15D15$Ingredient = F6(
	function (name, capacity, durability, flavor, texture, calories) {
		return {bv: calories, bw: capacity, bC: durability, bF: flavor, bN: name, b7: texture};
	});
...
var $author$project$Y15D16$sue = F2(
	function (hit, model) {
		var sues = A2(
			$elm$core$List$filter,
			function (s) {
				return A3($elm$core$Dict$foldl, hit, true, s.bV);
			},
			model);
...
var $author$project$Y15D18$Model = F4(
	function (lights, size, maxIndex, stuck) {
		return {S: lights, n: maxIndex, b3: size, bp: stuck};
	});
...
var $author$project$Y15D18$corner = F2(
	function (model, _v0) {
		var r = _v0.a;
		var c = _v0.b;
		return ((!r) || _Utils_eq(r, model.n)) && ((!c) || _Utils_eq(c, model.n));
	});
var $author$project$Y15D18$outside = F2(
	function (model, _v0) {
		var r = _v0.a;
		var c = _v0.b;
		return (_Utils_cmp(r, model.n) > 0) || ((r < 0) || ((_Utils_cmp(c, model.n) > 0) || (c < 0)));
	});
...
var $author$project$Y15D18$newVal = F2(
	function (model, cell) {
		if (model.bp && A2($author$project$Y15D18$corner, model, cell)) {
			return true;
		} else {
...
var $author$project$Y15D18$next = F2(
	function (model, _v0) {
		var r = _v0.a;
		var c = _v0.b;
		return (_Utils_cmp(c, model.n) > -1) ? _Utils_Tuple2(r + 1, 0) : _Utils_Tuple2(r, c + 1);
	});
...
var $author$project$Y15D19$count = F2(
	function (rgx, model) {
		return $elm$core$List$length(
			A2($elm$regex$Regex$find, rgx, model.T));
	});
	...
	function (matches, from, to, molecule, replacements) {
		...
		while (true) {
			if (!matches.b) {
				...
				var right = A3(
					$elm$core$String$slice,
					match.bJ + $elm$core$String$length(from),
					-1,
					molecule);
				var left = A3($elm$core$String$slice, 0, match.bJ, molecule);
	...
	while (true) {
		...
		if (!_v0.b) {
			...
			var matches = A2(
				...
				model.T);
			var replacements_ = A5($author$project$Y15D19$addToReplacements, matches, from, to, model.T, model.aF);
			var model_ = {T: model.T, aF: replacements_, a1: rules};
			var $temp$model = model_;
			model = $temp$model;
...
var $author$project$Y15D19$parse = function (input) {
	...
	return {T: molecule, aF: $elm$core$Set$empty, a1: rules};
};
...
var $author$project$Y15D21$Fighter = F5(
	function (hitp, damage, armor, cost, player) {
		return {bu: armor, a8: cost, bA: damage, aW: hitp, bR: player};
	});
...
var $author$project$Y15D21$fighterFromIndex = function (i) {
	var weapon = A2(
		...
		_List_fromArray(
			[0, 0, 0]),
		A2($elm$core$Array$get, i.aQ, $author$project$Y15D21$weapons));
	var ring2 = A2(
		$elm$core$Maybe$withDefault,
		_List_fromArray(
			[0, 0, 0]),
		A2($elm$core$Array$get, i.J, $author$project$Y15D21$rings));
	var ring1 = A2(
		$elm$core$Maybe$withDefault,
		_List_fromArray(
			[0, 0, 0]),
		A2($elm$core$Array$get, i.I, $author$project$Y15D21$rings));
	var armor = A2(
		$elm$core$Maybe$withDefault,
		_List_fromArray(
			[0, 0, 0]),
		A2($elm$core$Array$get, i._, $author$project$Y15D21$armors));
	var totals = A5(
		$elm$core$List$map4,
		F4(
			function (w, a, r1, r2) {
...
var $author$project$Y15D21$nextIndex = function (i) {
	return (i.J < 7) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{J: i.J + 1})) : ((i.I < 6) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{I: i.I + 1, J: i.I + 2})) : ((i._ < 5) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{_: i._ + 1, I: 0, J: 1})) : ((i.aQ < 4) ? $elm$core$Maybe$Just(
		_Utils_update(
			i,
			{_: 0, I: 0, J: 1, aQ: i.aQ + 1})) : $elm$core$Maybe$Nothing)));
};
	...
	function (attacker, defender) {
		...
		while (true) {
			if (attacker.aW <= 0) {
				...
				var damage = attacker.bA - defender.bu;
				var hitp = defender.aW - ((damage < 1) ? 1 : damage);
...
var $author$project$Y15D23$initModel = {g: 0, ay: $elm$core$Array$empty, w: $elm$core$Dict$empty};
	...
	function (line, model) {
		...
		if (((((sm.b && sm.a.b) && sm.a.b.b) && sm.a.b.b.b) && (!sm.a.b.b.b.b)) && (!sm.b.b)) {
			...
			return _Utils_update(
				model,
				{
					ay: A2($elm$core$Array$push, i, model.ay)
				});
		} else {
			return model;
		}
...
var $author$project$Y15D23$run = function (model) {
	run:
	while (true) {
		var instruction = A2($elm$core$Array$get, model.g, model.ay);
		if (instruction.$ === 1) {
			return model;
		} else {
				...
				switch (inst.$) {
					...
					case 5:
						...
						return _Utils_update(
							model,
							{
								g: model.g + ((!(A2($author$project$Y15D23$get, r, model) % 2)) ? j : 1)
							});
					case 6:
						var r = inst.a;
						var j = inst.b;
						return _Utils_update(
							model,
							{
								g: model.g + ((A2($author$project$Y15D23$get, r, model) === 1) ? j : 1)
							});
					default:
						return _Utils_update(
							model,
...
var $author$project$Y15D25$search = F2(
	function (_v0, model) {
		...
		while (true) {
			var row = _v0.a;
			var col = _v0.b;
			if (_Utils_eq(row, model.ai) && _Utils_eq(col, model.ac)) {
				return model;
			} else {
				var code_ = A2($elm$core$Basics$modBy, 33554393, model.au * 252533);
				var _v1 = (model.ai > 1) ? _Utils_Tuple2(model.ai - 1, model.ac + 1) : _Utils_Tuple2(model.ac + 1, 1);
				var row_ = _v1.a;
				var col_ = _v1.b;
				var $temp$_v0 = _Utils_Tuple2(row, col),
					$temp$model = {au: code_, ac: col_, ai: row_};
				_v0 = $temp$_v0;
				model = $temp$model;
				continue search;
			}
...
var $author$project$Y15D25$start = {au: 20151125, ac: 1, ai: 1};
var $author$project$Y15D25$answer = F2(
	function (part, input) {
		if (part === 1) {
			...
			return $elm$core$String$fromInt(model.au);
		} else {
...
var $author$project$Y16D01$blocks = function (model) {
	return $elm$core$Basics$abs(model.ah.L) + $elm$core$Basics$abs(model.ah.M);
};
			...
			if (steps.b) {
				...
				var newModel = A2(
					...
					_Utils_update(
						...
						{i: 1}),
					model);
				if (A2($elm$core$List$member, newModel.ah, visits)) {
					return newModel;
				} else {
					var newVisits = A2($elm$core$List$cons, newModel.ah, visits);
					if (step.i <= 1) {
						var $temp$steps = rest,
						...
						var $temp$steps = A2(
							$elm$core$List$cons,
							A2($author$project$Y16D01$Step, 2, step.i - 1),
							rest),
							$temp$visits = newVisits,
							$temp$model = newModel;
						steps = $temp$steps;
...
var $author$project$Y16D04$northPole = function (room) {
	var name = A3($author$project$Y16D04$decrypt, room.aH, '', room.bN);
	return A2(
		$elm$regex$Regex$contains,
...
var $author$project$Y16D04$Room = F3(
	function (name, sector, checksum) {
		return {bz: checksum, bN: name, aH: sector};
	});
...
var $author$project$Y16D04$potentialRoom = function (room) {
	return A2(
		...
		function (r) {
			return (r.aH > 0) ? $elm$core$Maybe$Just(r) : $elm$core$Maybe$Nothing;
		},
		room);
};
...
var $author$project$Y16D04$checksum = function (room) {
	var dict = A2($author$project$Y16D04$stats, room.bN, $elm$core$Dict$empty);
	var list = A2(
		$elm$core$List$take,
		5,
		A2(
...
var $author$project$Y16D12$process = function (state) {
	...
	while (true) {
		var instruction = A2(
			...
			A2($elm$core$Array$get, state.bJ, state.ay));
		if (_Utils_eq(instruction, $author$project$Y16D12$Invalid)) {
			...
			var index = function () {
				var _default = state.bJ + 1;
				switch (instruction.$) {
					case 5:
						var reg = instruction.a;
						var jmp = instruction.b;
						return ((!A2($author$project$Y16D12$get, reg, state)) || (!jmp)) ? _default : (state.bJ + jmp);
					case 4:
						var _int = instruction.a;
						var jmp = instruction.b;
						return ((!_int) || (!jmp)) ? _default : (state.bJ + jmp);
					default:
						return _default;
				}
			}();
...
var $author$project$Y16D13$same = F2(
	function (c1, c2) {
		return _Utils_eq(c1.L, c2.L) && _Utils_eq(c1.M, c2.M);
	});
var $author$project$Y16D13$getNeighbours = F3(
	function (fav, visited, cell) {
		...
		var _new = F2(
			function (old, move) {
				return A3($author$project$Y16D13$Cell, old.L + move.a, old.M + move.b, old.aU + 1);
			});
		...
		var inBounds = function (neighbour) {
			return (neighbour.L >= 0) && (neighbour.M >= 0);
		};
		return A2(
			$elm$core$List$filter,
			notSeenBefore,
...
var $author$project$Y16D13$start = {aU: 0, L: 1, M: 1};
...
var $author$project$Y16D15$Disc = F3(
	function (number, positions, position) {
		return {bO: number, aE: position, bj: positions};
	});
var $author$project$Y16D15$invalid = {bO: 0, aE: 0, bj: 1};
...
var $author$project$Y16D15$rotate = F2(
	function (time, disc) {
		return _Utils_update(
			disc,
			{
				aE: A2($elm$core$Basics$modBy, disc.bj, disc.aE + time)
			});
	});
...
var $author$project$Y16D17$found = function (location) {
	return (location.L === 3) && (location.M === 3);
};
var $author$project$Y16D17$Location = F3(
	function (x, y, path) {
		return {aD: path, L: x, M: y};
	});
	...
	function (location, _v0) {
		...
		if ((_Utils_cmp(code, $author$project$Y16D17$bCode) < 0) || (_Utils_cmp(code, $author$project$Y16D17$fCode) > 0)) {
			...
			var _v1 = function () {
				switch (index) {
					case 0:
						return _Utils_Tuple3(location.L, location.M - 1, 'U');
					case 1:
						return _Utils_Tuple3(location.L, location.M + 1, 'D');
					case 2:
						return _Utils_Tuple3(location.L - 1, location.M, 'L');
					default:
						return _Utils_Tuple3(location.L + 1, location.M, 'R');
				}
			}();
			var x = _v1.a;
			var y = _v1.b;
					...
					$elm$core$String$toList(
						A2(
							...
							$truqu$elm_md5$MD5$hex(
								_Utils_ap(passcode, location.aD)))))));
	});
				...
				if (maybeGoal.$ === 1) {
					...
					if (part === 1) {
						...
						var notGoals = A2(
							...
							locations);
						var newLen = $elm$core$String$length(goal.aD);
						var $temp$part = part,
							$temp$len = newLen,
	...
	function (num, blocks) {
		...
		while (true) {
			if (!blocks.b) {
				...
				var block = blocks.a;
				var rest = blocks.b;
				if (_Utils_cmp(num, block.ag) < 0) {
					return num;
				} else {
					var $temp$num = block.Y + 1,
						$temp$blocks = rest;
					num = $temp$num;
					blocks = $temp$blocks;
					continue lowest;
...
var $author$project$Y16D20$Block = F2(
	function (lower, upper) {
		return {ag: lower, Y: upper};
	});
var $author$project$Y16D20$merge = F2(
	function (b1, b2) {
		return (_Utils_cmp(b2.Y, b1.Y) < 1) ? b1 : A2($author$project$Y16D20$Block, b1.ag, b2.Y);
	});
var $author$project$Y16D20$mergeable = F2(
	function (b1, b2) {
		return _Utils_cmp(b2.ag, b1.Y + 1) < 1;
	});
...
var $author$project$Y16D22$Cluster = F3(
	function (width, height, nodes) {
		return {af: height, aC: nodes, Z: width};
	});
	...
	function (cluster, nodes) {
		...
		while (true) {
			if (!nodes.b) {
				...
				var newWidth = (_Utils_cmp(node.L + 1, cluster.Z) > 0) ? (node.L + 1) : cluster.Z;
				var newNodes = A3(
					$elm$core$Dict$insert,
					_Utils_Tuple2(node.L, node.M),
					node,
					cluster.aC);
				var newHeight = (_Utils_cmp(node.M + 1, cluster.af) > 0) ? (node.M + 1) : cluster.af;
...
var $author$project$Y16D22$Node = F5(
	function (x, y, size, used, avail) {
		return {a5: avail, b3: size, am: used, L: x, M: y};
	});
			...
			if ((!y) && _Utils_eq(x, cluster.Z - 1)) {
				...
				var node = A2(
					...
					A2(
						...
						_Utils_Tuple2(x, y),
						cluster.aC));
				return _Utils_eq(node, $author$project$Y16D22$invalidNode) ? ' ' : ((!node.am) ? '_' : ((node.b3 >= 500) ? '#' : '.'));
			}
		}
	});
...
var $author$project$Y16D22$print = function (cluster) {
	return A2(
		...
		A2(
			...
			A2($elm$core$List$range, 0, (-1) + cluster.af)));
};
var $author$project$Y16D22$viable1 = F4(
	function (x, y, total, cluster) {
		viable1:
		while (true) {
			if (_Utils_cmp(x, cluster.Z) > -1) {
				return total;
			} else {
				if (_Utils_cmp(y, cluster.af) > -1) {
					var $temp$x = x + 1,
						$temp$y = 0,
						$temp$total = total,
				...
				if (_Utils_cmp(y2, cluster.af) > -1) {
					...
					var node1 = A2(
						...
						A2(
							...
							_Utils_Tuple2(x1, y1),
							cluster.aC));
					var add21 = ((node2.am > 0) && (_Utils_cmp(node2.am, node1.a5) < 1)) ? 1 : 0;
					var add12 = ((node1.am > 0) && (_Utils_cmp(node1.am, node2.a5) < 1)) ? 1 : 0;
		...
		while (true) {
			...
			if (_v0.$ === 1) {
				...
				var update = function (node) {
					return ((!node.s) || (_Utils_cmp(node.s, current.s + 1) > 0)) ? _Utils_update(
						node,
						{s: current.s + 1}) : node;
				};
				var updatedNeighboursList = A2(
					$elm$core$List$map,
					update,
					A3($author$project$Y16D24$neighbours, current.L, current.M, state.aC));
				var maybeTarget = $elm$core$List$head(
					A2(
						$elm$core$List$filter,
						function (n) {
							return _Utils_eq(n.aO, target);
						},
				...
				if (!maybeTarget.$) {
					...
					var tmpNodes = A2($elm$core$Dict$union, newUpdatedNodes, state.aC);
		...
		if (_Utils_eq(source, target)) {
			...
			var newCurrent = $elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (n) {
						return _Utils_eq(n.aO, source);
					},
					$elm$core$Dict$values(state.aC)));
			var newNodes = function () {
				if (!newCurrent.$) {
					var node = newCurrent.a;
					return A2(
...
var $author$project$Y16D24$getDistances = function (state) {
	...
	var pairs = A2(
		...
		A2(
			...
			2,
			A2($elm$core$List$cons, '0', state.bq)));
...
var $author$project$Y16D24$Node = F4(
	function (x, y, v, distance) {
		return {s: distance, aO: v, L: x, M: y};
	});
var $author$project$Y16D24$State = F3(
	function (current, nodes, targets) {
		return {aT: current, aC: nodes, bq: targets};
	});
...
var $author$project$Y16D24$answer = F2(
	function (part, input) {
		...
		var paths = A2(
			...
			$author$project$Util$permutations(state.bq));
...
var $author$project$Y20D02$Password = F4(
	function (n1, n2, letter, password) {
		return {aY: letter, a_: n1, a$: n2, a0: password};
	});
...
var $author$project$Y20D02$valid1 = function (p) {
	var count = $elm$core$List$length(
		A2($elm$core$String$indices, p.aY, p.a0));
	return (_Utils_cmp(p.a_, count) < 1) && (_Utils_cmp(p.a$, count) > -1);
};
var $elm$core$Basics$xor = _Basics_xor;
var $author$project$Y20D02$valid2 = function (p) {
	var l2 = A3($elm$core$String$slice, p.a$ - 1, p.a$, p.a0);
	var l1 = A3($elm$core$String$slice, p.a_ - 1, p.a_, p.a0);
	return _Utils_eq(l1, p.aY) !== _Utils_eq(l2, p.aY);
};
...
var $author$project$Y20D03$count_ = F4(
	function (forrest, _v0, _v1, t) {
		...
		while (true) {
			...
			var x = _v1.a;
			var y = _v1.b;
			if (_Utils_cmp(y, forrest.af) > -1) {
				return t;
			} else {
				var dt = function () {
					var _v2 = A2($elm$core$Array$get, y, forrest.b0);
					if (!_v2.$) {
						var row = _v2.a;
						var _v3 = A2(
							$elm$core$Array$get,
							A2($elm$core$Basics$modBy, forrest.Z, x),
							row);
						if (!_v3.$) {
							var tree = _v3.a;
							return tree;
...
var $author$project$Y20D03$Forrest = F3(
	function (rows, width, height) {
		return {af: height, b0: rows, Z: width};
	});
	...
	function (lines, soFar) {
		if (lines.b) {
			...
			return A2(
				...
				rest,
				A3($author$project$Y20D07$ancestors__, line.a7, line.bi, soFar));
		} else {
			return soFar;
		}
	});
		...
		if (lines.b) {
			...
			return A2(
				...
				A3(
					$elm$core$Dict$insert,
					line.bi,
					$elm$core$Dict$fromList(line.a7),
					soFar));
		} else {
			return soFar;
		}
...
var $author$project$Y20D08$execute = function (c) {
	...
	while (true) {
		if (_Utils_eq(
			c.g,
			$elm$core$Array$length(c.p))) {
			return A2($author$project$Y20D08$Result, true, c.r);
		} else {
			if (A2($elm$core$Dict$member, c.g, c.bc)) {
				return A2($author$project$Y20D08$Result, false, c.r);
			} else {
				var mem = A3($elm$core$Dict$insert, c.g, true, c.bc);
				var _v0 = function () {
					var _v1 = A2($elm$core$Array$get, c.g, c.p);
					if (!_v1.$) {
						var inst = _v1.a;
						return _Utils_Tuple2(inst.bh, inst.a4);
					} else {
				...
				if (op === 'err') {
					...
					var $temp$c = A4($author$project$Y20D08$Console, i, acc, mem, c.p);
					c = $temp$c;
					continue execute;
				}
			}
...
var $author$project$Y20D08$repair = F2(
	function (i, c) {
		...
		while (true) {
			if (_Utils_cmp(
				i,
				$elm$core$Array$length(c.p)) > -1) {
				return 0;
			} else {
				var _v0 = function () {
					var _v1 = A2($elm$core$Array$get, i, c.p);
					if (!_v1.$) {
						var inst = _v1.a;
						return _Utils_Tuple2(inst.bh, inst.a4);
					} else {
...
var $author$project$Y20D08$answer = F2(
	function (part, input) {
		...
		return (part === 1) ? $elm$core$String$fromInt(
			$author$project$Y20D08$execute(console).r) : $elm$core$String$fromInt(
			...
			switch (seat) {
				case 1:
					return (!number) ? _Utils_update(
						...
						{
							O: data.O + 1,
							W: A4($author$project$Y20D11$put, r, c, 2, data.W)
						}) : data;
				case 2:
					...
					return (_Utils_cmp(number, threshold) > -1) ? _Utils_update(
						...
						{
							O: data.O + 1,
							W: A4($author$project$Y20D11$put, r, c, 1, data.W)
						}) : data;
				default:
					return data;
			}
	...
	function (part, seats) {
		return $author$project$Y20D11$occupied(
			A5(
				...
				0,
				seats,
				A2($author$project$Y20D11$Data, seats, 0)).W);
	});
...
var $author$project$Y20D12$distance = function (ferry) {
	return $elm$core$Basics$abs(ferry.L) + $elm$core$Basics$abs(ferry.M);
};
...
var $author$project$Y20D12$rotateWaypoint = F3(
	function (w, a, n) {
		return (n === 180) ? A2($author$project$Y20D12$Waypoint, -w.L, -w.M) : ((((a === 5) && (n === 90)) || ((a === 4) && (n === 270))) ? A2($author$project$Y20D12$Waypoint, -w.M, w.L) : ((((a === 4) && (n === 90)) || ((a === 5) && (n === 270))) ? A2($author$project$Y20D12$Waypoint, w.M, -w.L) : w));
	});
...
var $author$project$Y20D13$contest = function (schedule) {
	var pairs = A2(
		...
		function (b) {
			return _Utils_Tuple2(
				A2($elm$core$Basics$modBy, b.ax, b.ax - b.bP),
				b.ax);
		},
		schedule.a6);
...
var $author$project$Y20D15$Game = F3(
	function (turn, last, before) {
		return {at: before, aX: last, aL: turn};
	});
	...
	function (numbers, game) {
		...
		while (true) {
			if (numbers.b) {
				...
				var rest = numbers.b;
				var turn = game.aL + 1;
				var before = $elm$core$List$isEmpty(rest) ? game.at : A3($elm$core$Dict$insert, num, turn, game.at);
...
var $author$project$Y20D15$play = F2(
	function (upto, game) {
		play:
		while (true) {
			if (_Utils_eq(game.aL, upto)) {
				return game.aX;
			} else {
				var turn = game.aL + 1;
				var last = function () {
					var _v0 = A2($elm$core$Dict$get, game.aX, game.at);
					if (_v0.$ === 1) {
						return 0;
					} else {
						var previous = _v0.a;
						return game.aL - previous;
					}
				}();
				var before = A3($elm$core$Dict$insert, game.aX, game.aL, game.at);
				var $temp$upto = upto,
...
var $author$project$Y20D16$valid = F2(
	function (rule, num) {
		return A2($author$project$Y20D16$ok, num, rule.I) || A2($author$project$Y20D16$ok, num, rule.J);
	});
...
var $author$project$Y20D16$getIndexToName = function (data) {
	var validTickets = A2(
		...
		function (ticket) {
			return _Utils_eq(
				A2($author$project$Y20D16$findInvalid, data.a1, ticket),
				_List_Nil);
		},
		data.aB);
	var possibles = A3($author$project$Y20D16$getPossibles, validTickets, data.a1, $elm$core$Dict$empty);
...
var $author$project$Y20D16$Data = F3(
	function (rules, mine, near) {
		return {be: mine, aB: near, a1: rules};
	});
var $author$project$Y20D16$Rule = F3(
	function (name, r1, r2) {
		return {bN: name, I: r1, J: r2};
	});
				...
				switch (state) {
						...
						if (A2($elm$core$String$contains, 'your ticket', line)) {
							...
							if ((((((((((((matches.b && matches.a.b) && (!matches.a.a.$)) && matches.a.b.b) && (!matches.a.b.a.$)) && matches.a.b.b.b) && (!matches.a.b.b.a.$)) && matches.a.b.b.b.b) && (!matches.a.b.b.b.a.$)) && matches.a.b.b.b.b.b) && (!matches.a.b.b.b.b.a.$)) && (!matches.a.b.b.b.b.b.b)) && (!matches.b.b)) {
								...
								var data_ = _Utils_update(
									data,
									{
										a1: A2($elm$core$List$cons, rule, data.a1)
									});
					...
					case 2:
						...
						var data_ = ($elm$core$List$length(near) > 0) ? _Utils_update(
							data,
							{
								aB: A2($elm$core$List$cons, near, data.aB)
							}) : data;
						var $temp$state = state,
							$temp$data = data_,
							$temp$lines = rest;
...
var $author$project$Y20D16$sumInvalid = function (data) {
	return $elm$core$List$sum(
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$author$project$Y20D16$findInvalid(data.a1),
				data.aB)));
};
...
var $author$project$Y20D17$count = function (cube) {
	return $elm$core$Dict$size(cube.N);
};
var $author$project$Y20D17$index = function (xyz) {
	return A2(
		$elm$core$String$join,
		'-',
		A2($elm$core$List$map, $elm$core$String$fromInt, xyz));
};
var $author$project$Y20D17$neighbours = F5(
	function (x, y, z, w, active) {
		return $elm$core$List$length(
			A2(
				$elm$core$List$filterMap,
				function (i) {
					return A2($elm$core$Dict$get, i, active);
				},
				A2(
					$elm$core$List$map,
					$author$project$Y20D17$index,
					_List_fromArray(
						[
							_List_fromArray(
							[x - 1, y - 1, z - 1, w - 1]),
...
var $author$project$Y20D17$cycleCols = F6(
	function (w, z, y, cols, active, cube) {
		cycleCols:
		while (true) {
			if (cols.b) {
				var x = cols.a;
				var rest = cols.b;
				var n = A5($author$project$Y20D17$neighbours, x, y, z, w, active);
				...
				var cube_ = A2($elm$core$Dict$member, i, active) ? (((n === 2) || (n === 3)) ? cube : _Utils_update(
					cube,
					{
						N: A2($elm$core$Dict$remove, i, cube.N)
					})) : ((n === 3) ? _Utils_update(
					cube,
					{
						N: A3($elm$core$Dict$insert, i, true, cube.N)
					}) : cube);
				var $temp$w = w,
					$temp$z = z,
					$temp$y = y,
...
var $author$project$Y20D17$xRange = F2(
	function (n, cube) {
		return A2($elm$core$List$range, (-n) - 1, cube.Z + n);
	});
var $author$project$Y20D17$cycleRows = F6(
	function (n, w, z, rows, active, cube) {
		if (rows.b) {
			var y = rows.a;
			var rest = rows.b;
			var cols = A2($author$project$Y20D17$xRange, n, cube);
			return A6(
				$author$project$Y20D17$cycleRows,
				n,
				w,
				z,
				rest,
				active,
				A6($author$project$Y20D17$cycleCols, w, z, y, cols, active, cube));
		} else {
			return cube;
		}
	});
var $author$project$Y20D17$yRange = F2(
	function (n, cube) {
		return A2($elm$core$List$range, (-n) - 1, cube.af + n);
	});
var $author$project$Y20D17$cycleZeds = F5(
	function (n, w, zeds, active, cube) {
		if (zeds.b) {
			var z = zeds.a;
			var rest = zeds.b;
			var rows = A2($author$project$Y20D17$yRange, n, cube);
			return A5(
				$author$project$Y20D17$cycleZeds,
				n,
				w,
				rest,
				active,
				A6($author$project$Y20D17$cycleRows, n, w, z, rows, active, cube));
		} else {
			return cube;
		}
	});
var $author$project$Y20D17$zRange = function (n) {
	return A2($elm$core$List$range, (-n) - 1, n + 1);
};
var $author$project$Y20D17$cycleWuus = F4(
	function (n, wuus, active, cube) {
		if (wuus.b) {
			var w = wuus.a;
			var rest = wuus.b;
			var zeds = $author$project$Y20D17$zRange(n);
			return A4(
				$author$project$Y20D17$cycleWuus,
				n,
				rest,
				active,
				A5($author$project$Y20D17$cycleZeds, n, w, zeds, active, cube));
		} else {
			return cube;
		}
	});
var $author$project$Y20D17$wRange = F2(
	function (dim, n) {
		return (dim === 4) ? A2($elm$core$List$range, (-n) - 1, n + 1) : _List_fromArray(
			[0]);
	});
var $author$project$Y20D17$cycle = F3(
	function (dim, n, cube) {
		if (n >= 6) {
			return cube;
		} else {
			var wuus = A2($author$project$Y20D17$wRange, dim, n);
			return A3(
				$author$project$Y20D17$cycle,
				dim,
				n + 1,
				A4($author$project$Y20D17$cycleWuus, n, wuus, cube.N, cube));
		}
	});
var $author$project$Y20D17$Cube = F3(
	function (active, width, height) {
		return {N: active, af: height, Z: width};
	});
...
var $author$project$Y20D17$parseRows = F2(
	function (active, rows) {
		...
		while (true) {
			if (rows.b) {
				...
				var rest = rows.b;
				var active_ = A3(
					$author$project$Y20D17$parseCols,
					y,
					active,
					A2(
						$elm$core$List$indexedMap,
						F2(
							function (x, c) {
								return _Utils_Tuple2(x, c);
							}),
						$elm$core$String$toList(row)));
				var $temp$active = active_,
					$temp$rows = rest;
				active = $temp$active;
				rows = $temp$rows;
				continue parseRows;
...
var $author$project$Y20D17$parse = function (input) {
	var rows = A2(
		$elm$core$List$map,
		function ($) {
			return $.cn;
	...
	var active = A2(
		$author$project$Y20D17$parseRows,
		$elm$core$Dict$empty,
		A2(
			$elm$core$List$indexedMap,
			F2(
				function (y, r) {
					return _Utils_Tuple2(y, r);
				}),
			rows));
	return A3($author$project$Y20D17$Cube, active, width, height);
};
var $author$project$Y20D17$answer = F2(
	function (part, input) {
		var cube = $author$project$Y20D17$parse(input);
		return (part === 1) ? $elm$core$String$fromInt(
			$author$project$Y20D17$count(
				A3($author$project$Y20D17$cycle, 3, 0, cube))) : $elm$core$String$fromInt(
			$author$project$Y20D17$count(
	...
	function (part, expression) {
		...
		while (true) {
			var replacePluses = function (m) {
				return $elm$core$String$fromInt(
					$author$project$Y20D18$eval(m.cn));
			};
...
var $author$project$Y20D19$Rule = F3(
	function (trm, seq, alt) {
		return {bt: alt, b2: seq, b8: trm};
	});
var $author$project$Y20D19$consume = F3(
	function (book, rules, message) {
		consume:
		while (true) {
			if (rules.b) {
				var rule = rules.a;
				...
				if (!_v1.$) {
					...
					var _v2 = _List_fromArray(
						[rule.b2, rule.bt]);
					_v2$2:
					while (true) {
						if ((_v2.b && (!_v2.a.$)) && _v2.b.b) {
							if (_v2.b.a.$ === 1) {
								if (!_v2.b.b.b) {
									var seq = _v2.a.a;
									var _v3 = _v2.b;
									...
									var seqRules = A2(
										$elm$core$List$filterMap,
										function (num) {
											return A2($elm$core$Dict$get, num, book);
										},
										seq);
									var $temp$book = book,
										$temp$rules = _Utils_ap(seqRules, rest),
								...
								if (!_v2.b.b.b) {
									...
									var seqRules = A2(
										...
										seq);
									var seqTry = A3(
										$author$project$Y20D19$consume,
										book,
										_Utils_ap(seqRules, rest),
										message);
									if (_Utils_eq(seqTry, $elm$core$Maybe$Nothing)) {
										var altRules = A2(
											$elm$core$List$filterMap,
											function (num) {
												return A2($elm$core$Dict$get, num, book);
											...
											alt);
										var $temp$book = book,
											$temp$rules = _Utils_ap(altRules, rest),
											$temp$message = message;
										book = $temp$book;
										rules = $temp$rules;
										message = $temp$message;
...
var $author$project$Y20D19$test = F2(
	function (book, message) {
		var start = _List_fromArray(
			[
				A3(
				$author$project$Y20D19$Rule,
				$elm$core$Maybe$Nothing,
				$elm$core$Maybe$Just(
					_List_fromArray(
						['0'])),
		...
		var remainder = A3($author$project$Y20D19$consume, book, start, message);
...
var $author$project$Y20D19$count = function (data) {
	return $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			$elm$core$Basics$identity,
			A2(
				$elm$core$List$map,
				$author$project$Y20D19$test(data.ab),
				data.aZ)));
};
var $author$project$Y20D19$edit = function (data) {
	...
	var book = A3(
		...
		'11',
		r11,
		A3($elm$core$Dict$insert, '8', r8, data.ab));
	return _Utils_update(
		data,
		{ab: book});
};
		...
		var m = A2(
			...
			$elm$core$List$head(
				A2(
					...
					A2(
						$elm$regex$Regex$find,
						$author$project$Util$regex('^(0|[1-9]\\d*): (?:\\\"([ab])\\\"|([1-9]\\d*(?: [1-9]\\d*)*))(?: \\| )?([1-9]\\d*(?: [1-9]\\d*)*)?'),
						line))));
		_v0$3:
		while (true) {
			if ((m.b && (!m.a.$)) && m.b.b) {
				if (!m.b.a.$) {
					if ((((m.b.b.b && (m.b.b.a.$ === 1)) && m.b.b.b.b) && (m.b.b.b.a.$ === 1)) && (!m.b.b.b.b.b)) {
						var num = m.a.a;
						var _v1 = m.b;
						var trm = _v1.a.a;
						var _v2 = _v1.b;
							...
							if (!m.b.b.b.b.b) {
								...
								return A3(
									...
									A3(
										$author$project$Y20D19$Rule,
										$elm$core$Maybe$Nothing,
										$author$project$Y20D19$toSeq(seq),
										$elm$core$Maybe$Nothing),
									book);
							} else {
								break _v0$3;
							...
							if (!m.b.b.b.b.b) {
								...
								return A3(
									...
									A3(
										...
										$elm$core$Maybe$Nothing,
										$author$project$Y20D19$toSeq(seq),
										$author$project$Y20D19$toSeq(alt)),
									book);
							} else {
								break _v0$3;
							}
...
var $author$project$Y20D19$parseLine = F2(
	function (data, lines) {
		parseLine:
		while (true) {
			if (lines.b) {
				...
				var data_ = A2(
					...
					data,
					{
						ab: A2($author$project$Y20D19$parseRule, line, data.ab)
					}) : _Utils_update(
					data,
					{
						aZ: A2($elm$core$List$cons, line, data.aZ)
					});
				var $temp$data = data_,
					$temp$lines = rest;
				data = $temp$data;
...
var $author$project$Y20D19$parse = function (input) {
	return A2(
		$author$project$Y20D19$parseLine,
		A2($author$project$Y20D19$Data, $elm$core$Dict$empty, _List_Nil),
		A2(
			$elm$core$List$filter,
			function (e) {
				return $elm$core$String$length(e) > 0;
...
var $author$project$Y20D19$answer = F2(
	function (part, input) {
		var data = $author$project$Y20D19$parse(input);
		return (part === 1) ? $elm$core$String$fromInt(
			$author$project$Y20D19$count(data)) : $elm$core$String$fromInt(
...
var $author$project$Y20D20$Data = F4(
	function (images, edges, edgeConnections, imageConnections) {
		return {cf: edgeConnections, cg: edges, bI: imageConnections, ck: images};
	});
var $author$project$Y20D20$edgeConnectionsFromEdges_ = F3(
	function (id, edges, edgeConnections) {
		if (edges.b) {
			var edge = edges.a;
			var rest = edges.b;
			var ids = A2(
				...
				A2(
					$elm$core$Maybe$withDefault,
					$elm$core$Set$empty,
					A2($elm$core$Dict$get, edge, edgeConnections)));
			return A3(
				$author$project$Y20D20$edgeConnectionsFromEdges_,
				id,
				rest,
				A3($elm$core$Dict$insert, edge, ids, edgeConnections));
		} else {
			return edgeConnections;
		}
	});
var $author$project$Y20D20$edgeConnectionsFromEdges = F2(
	function (pairs, edgeConnections) {
		if (pairs.b) {
			var _v1 = pairs.a;
			var id = _v1.a;
			var edges = _v1.b;
			var rest = pairs.b;
			return A2(
				$author$project$Y20D20$edgeConnectionsFromEdges,
				rest,
				A3(
					$author$project$Y20D20$edgeConnectionsFromEdges_,
					id,
					$elm$core$Set$toList(edges),
					edgeConnections));
		} else {
			return edgeConnections;
		}
	});
var $author$project$Y20D20$edgesFromImages = F2(
	function (_v0, rows) {
		var top = $elm$core$List$head(rows);
		var right = $elm$core$Maybe$Just(
			$elm$core$String$fromList(
				A2(
					$elm$core$List$filterMap,
					$elm$core$Basics$identity,
		...
		var reversed = A2($elm$core$List$map, $elm$core$String$reverse, combined);
		return $elm$core$Set$fromList(
			_Utils_ap(combined, reversed));
	});
var $author$project$Y20D20$imageConnectionsFromEdgeConnections = F2(
	function (pairs, imageConnections) {
		imageConnectionsFromEdgeConnections:
		while (true) {
			if (pairs.b) {
				var _v1 = pairs.a;
				var ids = _v1.b;
				var rest = pairs.b;
				var _v2 = $elm$core$Set$toList(ids);
				if ((_v2.b && _v2.b.b) && (!_v2.b.b.b)) {
					...
					var s2 = A2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							$elm$core$Set$empty,
							A2($elm$core$Dict$get, id2, imageConnections)));
					var s1 = A2(
						$elm$core$Set$insert,
						id2,
						A2(
							$elm$core$Maybe$withDefault,
							$elm$core$Set$empty,
							A2($elm$core$Dict$get, id1, imageConnections)));
					var imageConnections_ = A3(
						$elm$core$Dict$insert,
						id2,
						s2,
						A3($elm$core$Dict$insert, id1, s1, imageConnections));
					var $temp$pairs = rest,
						$temp$imageConnections = imageConnections_;
					pairs = $temp$pairs;
					imageConnections = $temp$imageConnections;
					continue imageConnectionsFromEdgeConnections;
				} else {
					var $temp$pairs = rest,
						$temp$imageConnections = imageConnections;
					pairs = $temp$pairs;
					imageConnections = $temp$imageConnections;
					continue imageConnectionsFromEdgeConnections;
				}
			} else {
				return imageConnections;
			}
		}
	});
var $author$project$Y20D20$parse_ = F3(
	function (lines, mid, images) {
		parse_:
		while (true) {
			if (lines.b) {
				var line = lines.a;
				...
				var idMatches = A2(
					$elm$regex$Regex$find,
					$author$project$Util$regex('^Tile ([1-9]\\d*):$'),
					line);
				if ($elm$core$List$length(idMatches) === 1) {
					var id = A2(
						$elm$core$Maybe$withDefault,
						0,
						$elm$core$String$toInt(
										...
										A2(
											...
											$elm$core$List$head(
												A2(
													...
													idMatches))))))));
					var $temp$lines = rest,
						$temp$mid = $elm$core$Maybe$Just(id),
						$temp$images = images;
					lines = $temp$lines;
					mid = $temp$mid;
					images = $temp$images;
					...
					var rowMatches = A2(
						$elm$regex$Regex$find,
						$author$project$Util$regex('^([.#]{10})$'),
						line);
					if ($elm$core$List$length(rowMatches) === 1) {
						var row = A2(
							$elm$core$Maybe$withDefault,
							'',
							A2(
									...
									A2(
										...
										$elm$core$List$head(
											A2(
												...
												rowMatches))))));
						var id = A2($elm$core$Maybe$withDefault, 0, mid);
						var images_ = function () {
							if ((id > 0) && ($elm$core$String$length(row) === 10)) {
								var rows = A2(
									$elm$core$Maybe$withDefault,
									_List_Nil,
									A2($elm$core$Dict$get, id, images));
								return A3(
									$elm$core$Dict$insert,
									id,
...
var $author$project$Y20D20$parse = function (input) {
	var lines = A2(
		$elm$core$List$filter,
		function (e) {
			return $elm$core$String$length(e) > 0;
		...
		A2(
			...
			A2(
				...
				$author$project$Util$regex('\\n'),
				input)));
	var images = A3($author$project$Y20D20$parse_, lines, $elm$core$Maybe$Nothing, $elm$core$Dict$empty);
	var edges = A2($elm$core$Dict$map, $author$project$Y20D20$edgesFromImages, images);
	var edgeConnections = A2(
		$author$project$Y20D20$edgeConnectionsFromEdges,
		$elm$core$Dict$toList(edges),
		$elm$core$Dict$empty);
	var imageConnections = A2(
		$author$project$Y20D20$imageConnectionsFromEdgeConnections,
		$elm$core$Dict$toList(edgeConnections),
		$elm$core$Dict$empty);
	return A4($author$project$Y20D20$Data, images, edges, edgeConnections, imageConnections);
};
var $author$project$Y20D20$product = function (data) {
	return $elm$core$List$product(
		A2(
			$elm$core$List$map,
			$elm$core$Tuple$first,
			$elm$core$Dict$toList(
				A2(
					...
					F2(
						function (_v0, ids) {
							return $elm$core$Set$size(ids) === 2;
						}),
					data.bI))));
};
var $author$project$Y20D20$answer = F2(
	function (part, input) {
		var data = $author$project$Y20D20$parse(input);
		return (part === 1) ? $elm$core$String$fromInt(
			$author$project$Y20D20$product(data)) : 'using ruby for this part';
	});
var $author$project$Y20D21$Data = F2(
	function (a2i, foods) {
		return {a3: a2i, ba: foods};
	});
...
var $author$project$Y20D21$update = F3(
	function (ingredients, alergen, a2is) {
		var ingredients_ = A2($elm$core$Dict$member, alergen, a2is) ? A2(
			$elm$core$Set$intersect,
			ingredients,
			A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Set$empty,
				A2($elm$core$Dict$get, alergen, a2is))) : ingredients;
		return A3($elm$core$Dict$insert, alergen, ingredients_, a2is);
	});
var $author$project$Y20D21$build = F2(
	function (pairs, a2is) {
		build:
		while (true) {
			if (pairs.b) {
				...
				var alergens = _v1.b;
				var rest = pairs.b;
				var ingredients_ = $elm$core$Set$fromList(
					A2($elm$core$String$split, ' ', ingredients));
				var alergens_ = A2($elm$core$String$split, ', ', alergens);
				var a2is_ = A3(
					$elm$core$List$foldl,
					$author$project$Y20D21$update(ingredients_),
					a2is,
					alergens_);
				var $temp$pairs = rest,
					$temp$a2is = a2is_;
...
var $author$project$Y20D21$reduce = F2(
	function (a2is, a2i) {
		reduce:
		while (true) {
			var certain = $elm$core$Dict$fromList(
				A2(
					...
					function (_v2) {
						var alergen = _v2.a;
						var ingredients = _v2.b;
						var ingredient = A2(
							$elm$core$Maybe$withDefault,
							'ingredient',
							$elm$core$List$head(
								$elm$core$Set$toList(ingredients)));
						return _Utils_Tuple2(alergen, ingredient);
					},
					$elm$core$Dict$toList(
						A2(
							$elm$core$Dict$filter,
							F2(
								function (_v1, ingredients) {
									return $elm$core$Set$size(ingredients) === 1;
								}),
							a2is))));
			if (!$elm$core$Dict$size(certain)) {
				return a2i;
			} else {
				var done = $elm$core$Set$fromList(
					$elm$core$Dict$values(certain));
				var a2is_ = A2(
					$elm$core$Dict$map,
					F2(
						function (_v0, ingredients) {
							return A2($elm$core$Set$diff, ingredients, done);
						}),
					a2is);
				var a2i_ = A2($elm$core$Dict$union, certain, a2i);
				var $temp$a2is = a2is_,
					$temp$a2i = a2i_;
				a2is = $temp$a2is;
				a2i = $temp$a2i;
...
var $author$project$Y20D21$parse = function (input) {
	var pairs = A2(
		$elm$core$List$filterMap,
		function (m) {
			if ((((m.b && (!m.a.$)) && m.b.b) && (!m.b.a.$)) && (!m.b.b.b)) {
				var ingredients = m.a.a;
				var _v1 = m.b;
				var alergens = _v1.a.a;
				return $elm$core$Maybe$Just(
					_Utils_Tuple2(ingredients, alergens));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		},
		A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$elm$regex$Regex$find(
						$author$project$Util$regex('^([a-z]+(?: [a-z]+)*) \\(contains ([a-z]+(?:, [a-z]+)*)\\)$')),
					A2(
						$elm$regex$Regex$split,
						$author$project$Util$regex('\\n'),
						input)))));
	...
	var a2is = A2($author$project$Y20D21$build, pairs, $elm$core$Dict$empty);
	var a2i = A2($author$project$Y20D21$reduce, a2is, $elm$core$Dict$empty);
	return A2($author$project$Y20D21$Data, a2i, foods);
};
...
var $author$project$Y20D21$part1 = function (data) {
	var ingredientsWithAlergens = $elm$core$Set$fromList(
		$elm$core$Dict$values(data.a3));
	var allIngredients = A3(
		$elm$core$List$foldl,
		F2(
			function (a, b) {
		...
		$elm$core$Set$empty,
		data.ba);
	var ingredientsWithoutAlergens = $elm$core$Set$toList(
		A2($elm$core$Set$diff, allIngredients, ingredientsWithAlergens));
	return $elm$core$String$fromInt(
		$elm$core$List$sum(
			A2(
				$elm$core$List$map,
					...
					return $elm$core$List$length(
						A2(
							...
							function (ingredients) {
								return A2($elm$core$Set$member, ingredient, ingredients);
							},
							data.ba));
				},
				ingredientsWithoutAlergens)));
};
var $author$project$Y20D21$part2 = function (data) {
	return A2(
		$elm$core$String$join,
		',',
		A2(
			...
			A2(
				...
				$elm$core$Dict$toList(data.a3))));
};
var $author$project$Y20D21$answer = F2(
	function (part, input) {
		var data = $author$project$Y20D21$parse(input);
		return (part === 1) ? $author$project$Y20D21$part1(data) : $author$project$Y20D21$part2(data);
	});
var $author$project$Y20D22$Game = F4(
	function (player1, player2, winner, history) {
		return {aV: history, u: player1, v: player2, ao: winner};
	});
var $author$project$Y20D22$check = function (game) {
	var d2 = A2(
		$elm$core$String$join,
		'|',
		A2($elm$core$List$map, $elm$core$String$fromInt, game.v));
	var d1 = A2(
		$elm$core$String$join,
		'|',
		A2($elm$core$List$map, $elm$core$String$fromInt, game.u));
	var digest = d1 + ('||' + d2);
	return A2($elm$core$Set$member, digest, game.aV) ? _Utils_update(
		game,
		{ao: 1}) : _Utils_update(
		game,
		{
			aV: A2($elm$core$Set$insert, digest, game.aV)
		});
};
var $author$project$Y20D22$combat = F2(
	function (recursive, game_) {
		combat:
		while (true) {
			var game = $author$project$Y20D22$check(game_);
			if (!(!game.ao)) {
				return game;
			} else {
				var _v0 = _Utils_Tuple2(game.u, game.v);
				if (_v0.a.b && _v0.b.b) {
					var _v1 = _v0.a;
					var c1 = _v1.a;
					var rest1 = _v1.b;
					...
					var c2 = _v2.a;
					var rest2 = _v2.b;
					var winner = (recursive && ((_Utils_cmp(
						$elm$core$List$length(rest1),
						c1) > -1) && (_Utils_cmp(
						$elm$core$List$length(rest2),
						c2) > -1))) ? A2(
						$author$project$Y20D22$combat,
						true,
						A4(
							$author$project$Y20D22$Game,
							A2($elm$core$List$take, c1, rest1),
							A2($elm$core$List$take, c2, rest2),
							0,
							$elm$core$Set$empty)).ao : ((_Utils_cmp(c1, c2) > 0) ? 1 : 2);
					if (winner === 1) {
						var $temp$recursive = recursive,
							$temp$game_ = _Utils_update(
							game,
							{
								u: _Utils_ap(
									rest1,
					...
					var winner = function () {
						var _v3 = _Utils_Tuple2(
							$elm$core$List$isEmpty(game.u),
							$elm$core$List$isEmpty(game.v));
						_v3$2:
						while (true) {
							if (!_v3.a) {
								if (_v3.b) {
...
var $author$project$Y20D22$parse_ = F3(
	function (game, player, lines) {
		parse_:
		while (true) {
			if (lines.b) {
				var line = lines.a;
				var rest = lines.b;
				if (A2($elm$core$String$contains, 'Player 2', line)) {
					var $temp$game = game,
						$temp$player = 2,
						$temp$lines = rest;
					game = $temp$game;
...
var $author$project$Y20D22$parse = function (input) {
	return A3(
		$author$project$Y20D22$parse_,
		A4($author$project$Y20D22$Game, _List_Nil, _List_Nil, 0, $elm$core$Set$empty),
		1,
		A2(
			$elm$regex$Regex$split,
			$author$project$Util$regex('\\n'),
...
var $author$project$Y20D22$score = function (game) {
	var cards = function () {
		var _v0 = game.ao;
		switch (_v0) {
			case 1:
...
var $author$project$Y20D22$answer = F2(
	function (part, input) {
		var recursive = part !== 1;
		var game = $author$project$Y20D22$parse(input);
		return $elm$core$String$fromInt(
			$author$project$Y20D22$score(
				A2($author$project$Y20D22$combat, recursive, game)));
	});
var $author$project$Y20D23$get = F2(
	function (k, d) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
...
var $author$project$Y20D23$after1_ = F3(
	function (cup, cups, after) {
		after1_:
		while (true) {
			var next = A2($author$project$Y20D23$get, cup, cups.e);
			if (next === 1) {
				return after;
			} else {
				var $temp$cup = next,
					$temp$cups = cups,
					$temp$after = _Utils_ap(
					after,
					$elm$core$String$fromInt(next));
				cup = $temp$cup;
				cups = $temp$cups;
				after = $temp$after;
				continue after1_;
...
var $author$project$Y20D23$after1 = function (cups) {
	return A3($author$project$Y20D23$after1_, 1, cups, '');
};
var $author$project$Y20D23$link = F2(
	function (list, cups) {
		link:
		while (true) {
			if (list.b) {
				if (list.b.b) {
					...
					var c2 = _v1.a;
					var rest = _v1.b;
					var $temp$list = A2($elm$core$List$cons, c2, rest),
						$temp$cups = _Utils_update(
						cups,
						{
							e: A3($elm$core$Dict$insert, c1, c2, cups.e),
							b3: cups.b3 + 1
						});
					list = $temp$list;
					cups = $temp$cups;
					...
					return _Utils_update(
						cups,
						{
							e: A3($elm$core$Dict$insert, last, cups.aT, cups.e),
							b3: cups.b3 + 1
						});
				}
			} else {
...
var $author$project$Y20D23$extend = F2(
	function (size, cups) {
		var last = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$List$head(
				A2(
					...
					A2(
						...
						function (_v0) {
							var c2 = _v0.b;
							return _Utils_eq(c2, cups.aT);
						},
						$elm$core$Dict$toList(cups.e)))));
		var first = cups.b3 + 1;
		var list = A2($elm$core$List$range, first, size);
		var next = A3($elm$core$Dict$insert, last, first, cups.e);
		return A2(
			$author$project$Y20D23$link,
			list,
			_Utils_update(
				cups,
				{e: next}));
	});
var $author$project$Y20D23$destination = F3(
	function (current, max, excluded) {
		destination:
		while (true) {
			var d = (current > 1) ? (current - 1) : max;
			if (A2($elm$core$List$member, d, excluded)) {
				var $temp$current = d,
					$temp$max = max,
...
var $author$project$Y20D23$move = F2(
	function (n, cups) {
		move:
		while (true) {
			if (!n) {
				...
				var c1 = A2($author$project$Y20D23$get, cups.aT, cups.e);
				var c2 = A2($author$project$Y20D23$get, c1, cups.e);
				var c3 = A2($author$project$Y20D23$get, c2, cups.e);
				var current = A2($author$project$Y20D23$get, c3, cups.e);
				var d1 = A3(
					$author$project$Y20D23$destination,
					cups.aT,
					cups.b3,
					_List_fromArray(
						[c1, c2, c3]));
				var d2 = A2($author$project$Y20D23$get, d1, cups.e);
				var next = A3(
					$elm$core$Dict$insert,
					cups.aT,
					current,
					A3(
						...
						c3,
						d2,
						A3($elm$core$Dict$insert, d1, c1, cups.e)));
				var $temp$n = n - 1,
					$temp$cups = _Utils_update(
					cups,
					{aT: current, e: next});
...
var $author$project$Y20D23$Cups = F3(
	function (current, size, next) {
		return {aT: current, e: next, b3: size};
	});
var $author$project$Y20D23$parse = function (input) {
	var list = A2(
		$elm$core$List$filterMap,
		$elm$core$String$toInt,
		A2(
	...
	return A2(
		$author$project$Y20D23$link,
		list,
		A3($author$project$Y20D23$Cups, current, 0, $elm$core$Dict$empty));
};
var $author$project$Y20D23$stars1 = function (cups) {
	var c1 = A2($author$project$Y20D23$get, 1, cups.e);
	var c2 = A2($author$project$Y20D23$get, c1, cups.e);
	return $elm$core$String$fromInt(c1 * c2);
};
var $author$project$Y20D23$answer = F2(
	function (part, input) {
		var cups = $author$project$Y20D23$parse(input);
		return (part === 1) ? $author$project$Y20D23$after1(
			A2($author$project$Y20D23$move, 100, cups)) : $author$project$Y20D23$stars1(
			A2(
				$author$project$Y20D23$move,
				10000000,
				A2($author$project$Y20D23$extend, 1000000, cups)));
	});
var $author$project$Y20D24$black = false;
var $author$project$Y20D24$count = function (tiles) {
	return $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (t) {
				return _Utils_eq(t, $author$project$Y20D24$black);
			},
			$elm$core$Dict$values(tiles)));
};
var $author$project$Y20D24$white = true;
var $author$project$Y20D24$expand__ = F2(
	function (positions, tiles) {
		...
		while (true) {
			if (positions.b) {
				...
				var tiles_ = A2($elm$core$Dict$member, position, tiles) ? tiles : A3($elm$core$Dict$insert, position, $author$project$Y20D24$white, tiles);
				var $temp$positions = rest,
					$temp$tiles = tiles_;
...
var $author$project$Y20D24$nearby = function (position) {
	var coordinates = A2(
		$elm$core$List$map,
		$elm$core$String$toInt,
		A2($elm$core$String$split, '|', position));
	var positions = function () {
		if ((((((coordinates.b && (!coordinates.a.$)) && coordinates.b.b) && (!coordinates.b.a.$)) && coordinates.b.b.b) && (!coordinates.b.b.a.$)) && (!coordinates.b.b.b.b)) {
			var x = coordinates.a.a;
			...
			return _List_fromArray(
				[
					A3($author$project$Y20D24$Position, x + 1, y - 1, z),
					A3($author$project$Y20D24$Position, x - 1, y + 1, z),
					A3($author$project$Y20D24$Position, x + 1, y, z - 1),
					A3($author$project$Y20D24$Position, x, y + 1, z - 1),
					A3($author$project$Y20D24$Position, x, y - 1, z + 1),
					A3($author$project$Y20D24$Position, x - 1, y, z + 1)
				]);
		} else {
	...
	return A2($elm$core$List$map, $author$project$Y20D24$toKey, positions);
};
var $author$project$Y20D24$expand_ = F2(
	function (positions, tiles) {
		if (positions.b) {
			var position = positions.a;
			var rest = positions.b;
			var neighbours = $author$project$Y20D24$nearby(position);
			return A2(
				$author$project$Y20D24$expand_,
				rest,
				A2($author$project$Y20D24$expand__, neighbours, tiles));
		} else {
			return tiles;
		}
	});
var $author$project$Y20D24$expand = function (tiles) {
	var blacks = A2(
		$elm$core$Dict$filter,
		F2(
			function (_v0, tile) {
				return _Utils_eq(tile, $author$project$Y20D24$black);
			}),
		tiles);
	var positions = $elm$core$Dict$keys(blacks);
	return A2($author$project$Y20D24$expand_, positions, tiles);
};
var $author$project$Y20D24$flip_ = F3(
	function (positions, oldTiles, tiles) {
		if (positions.b) {
			var position = positions.a;
			var rest = positions.b;
			var tile = A2(
				$elm$core$Maybe$withDefault,
				$author$project$Y20D24$white,
				A2($elm$core$Dict$get, position, oldTiles));
			var blacks = $elm$core$List$length(
				A2(
					$elm$core$List$filter,
					function (t) {
						return _Utils_eq(t, $author$project$Y20D24$black);
					...
					A2(
						$elm$core$List$map,
						$elm$core$Maybe$withDefault($author$project$Y20D24$white),
						A2(
							$elm$core$List$map,
							function (p) {
								return A2($elm$core$Dict$get, p, oldTiles);
							},
							$author$project$Y20D24$nearby(position)))));
			var tile_ = (_Utils_eq(tile, $author$project$Y20D24$black) && ((!blacks) || (blacks > 2))) ? $author$project$Y20D24$white : ((_Utils_eq(tile, $author$project$Y20D24$white) && (blacks === 2)) ? $author$project$Y20D24$black : tile);
			return A3(
				$author$project$Y20D24$flip_,
				rest,
				oldTiles,
				A3($elm$core$Dict$insert, position, tile_, tiles));
		} else {
			return tiles;
		}
	});
var $author$project$Y20D24$flip = F2(
	function (days, tiles) {
		flip:
		while (true) {
			if (days <= 0) {
				...
				var expanded = $author$project$Y20D24$expand(tiles);
				var positions = $elm$core$Dict$keys(expanded);
				var tiles_ = A3($author$project$Y20D24$flip_, positions, expanded, $elm$core$Dict$empty);
...
var $author$project$Y20D24$parseSteps = function (input) {
	return A2(
		$elm$core$List$map,
		function ($) {
			return $.cn;
		...
		A2(
			$elm$regex$Regex$find,
			$author$project$Util$regex('e|w|ne|nw|se|sw'),
			input));
};
var $author$project$Y20D24$parse = function (input) {
	return A2(
		$elm$core$List$map,
		$author$project$Y20D24$parseSteps,
		A2(
			$elm$core$List$filter,
			function (l) {
...
var $author$project$Y20D24$follow_ = F2(
	function (walk, p) {
		if (walk.b) {
			var step = walk.a;
			var steps = walk.b;
			var d = function () {
				switch (step) {
					case 'e':
						return A3($author$project$Y20D24$Position, 1, -1, 0);
					case 'w':
						return A3($author$project$Y20D24$Position, -1, 1, 0);
					case 'ne':
						return A3($author$project$Y20D24$Position, 1, 0, -1);
					case 'nw':
						return A3($author$project$Y20D24$Position, 0, 1, -1);
					case 'se':
						return A3($author$project$Y20D24$Position, 0, -1, 1);
					case 'sw':
						return A3($author$project$Y20D24$Position, -1, 0, 1);
					default:
						return A3($author$project$Y20D24$Position, 0, 0, 0);
				}
			}();
			return A2(
				$author$project$Y20D24$follow_,
				steps,
				A3($author$project$Y20D24$Position, p.L + d.L, p.M + d.M, p.a2 + d.a2));
		} else {
			return p;
		}
	});
var $author$project$Y20D24$follow = function (walk) {
	return A2(
		$author$project$Y20D24$follow_,
		walk,
		A3($author$project$Y20D24$Position, 0, 0, 0));
};
var $author$project$Y20D24$renovate_ = F2(
	function (walks, tiles) {
		if (walks.b) {
			var walk = walks.a;
			var rest = walks.b;
			var position = $author$project$Y20D24$toKey(
				$author$project$Y20D24$follow(walk));
			var tile = !A2(
				$elm$core$Maybe$withDefault,
				$author$project$Y20D24$white,
				A2($elm$core$Dict$get, position, tiles));
			return A2(
				$author$project$Y20D24$renovate_,
				rest,
				A3($elm$core$Dict$insert, position, tile, tiles));
		} else {
			return tiles;
		}
	});
var $author$project$Y20D24$renovate = function (walks) {
	return A2($author$project$Y20D24$renovate_, walks, $elm$core$Dict$empty);
};
var $author$project$Y20D24$answer = F2(
	function (part, input) {
		var list = $author$project$Y20D24$parse(input);
		return (part === 1) ? $elm$core$String$fromInt(
			$author$project$Y20D24$count(
				$author$project$Y20D24$renovate(list))) : $elm$core$String$fromInt(
			$author$project$Y20D24$count(
				A2(
					$author$project$Y20D24$flip,
					100,
					$author$project$Y20D24$renovate(list))));
	});
var $author$project$Y20D25$Key = F2(
	function (_public, loops) {
		return {bL: loops, bX: _public};
	});
var $author$project$Y20D25$Keys = F2(
	function (card, door) {
		return {bx: card, bB: door};
	});
var $author$project$Y20D25$transform = F3(
	function (n, subject, value) {
		transform:
		while (true) {
			if (n <= 0) {
				return value;
				...
				var $temp$n = n - 1,
					...
					$temp$value = (subject * value) % 20201227;
				n = $temp$n;
...
var $author$project$Y20D25$guess_ = F3(
	function (_public, loops, value) {
		guess_:
		while (true) {
			var value_ = A3($author$project$Y20D25$transform, 1, 7, value);
			if (_Utils_eq(value_, _public)) {
				return loops;
			} else {
				var $temp$public = _public,
					$temp$loops = loops + 1,
					$temp$value = value_;
				_public = $temp$public;
				loops = $temp$loops;
...
var $author$project$Y20D25$guess = function (_public) {
	return A3($author$project$Y20D25$guess_, _public, 1, 1);
};
var $author$project$Y20D25$parse = function (input) {
	var list = A2(
		$elm$core$List$map,
		$elm$core$String$toInt,
		A2(
			...
			A2(
				...
				$author$project$Util$regex('\\d+'),
				input)));
	if ((((list.b && (!list.a.$)) && list.b.b) && (!list.b.a.$)) && (!list.b.b.b)) {
		var card = list.a.a;
		var _v1 = list.b;
		var door = _v1.a.a;
		return A2(
			$author$project$Y20D25$Keys,
			A2(
				$author$project$Y20D25$Key,
				card,
				$author$project$Y20D25$guess(card)),
			A2(
				$author$project$Y20D25$Key,
				door,
				$author$project$Y20D25$guess(door)));
	} else {
		return A2(
			$author$project$Y20D25$Keys,
			A2($author$project$Y20D25$Key, 0, 0),
			A2($author$project$Y20D25$Key, 0, 0));
	}
};
var $author$project$Y20D25$secret = function (keys) {
	return A3($author$project$Y20D25$transform, keys.bx.bL, keys.bB.bX, 1);
};
...
var $author$project$Y20$answer = F3(
	function (day, part, input) {
		switch (day) {
			...
			case 19:
				return A2($author$project$Y20D19$answer, part, input);
			case 20:
				return A2($author$project$Y20D20$answer, part, input);
			case 21:
				return A2($author$project$Y20D21$answer, part, input);
			case 22:
				return A2($author$project$Y20D22$answer, part, input);
			case 23:
				return A2($author$project$Y20D23$answer, part, input);
			case 24:
				return A2($author$project$Y20D24$answer, part, input);
			case 25:
				return A2($author$project$Y20D25$answer, part, input);
			default:
...
var $author$project$Y21D02$multiply = function (p) {
	return $elm$core$String$fromInt(p.C * p.E);
};
var $author$project$Y21D02$Position = F3(
	function (depth, horizontal, aim) {
		return {ar: aim, C: depth, E: horizontal};
	});
var $author$project$Y21D02$navigate1 = F2(
	function (p, list) {
		navigate1:
		while (true) {
			if (!list.b) {
				...
				var position = function () {
					...
					switch (_v1) {
						case 0:
							return A3($author$project$Y21D02$Position, p.C + c.z, p.E, 0);
						case 2:
							return A3($author$project$Y21D02$Position, p.C - c.z, p.E, 0);
						default:
							return A3($author$project$Y21D02$Position, p.C, p.E + c.z, 0);
					}
				}();
				var $temp$p = position,
					$temp$list = commands;
...
var $author$project$Y21D02$navigate2 = F2(
	function (p, list) {
		navigate2:
		while (true) {
			if (!list.b) {
				...
				var position = function () {
					...
					switch (_v1) {
						case 0:
							return A3($author$project$Y21D02$Position, p.C, p.E, p.ar + c.z);
						case 2:
							return A3($author$project$Y21D02$Position, p.C, p.E, p.ar - c.z);
						default:
							return A3($author$project$Y21D02$Position, p.C + (p.ar * c.z), p.E + c.z, p.ar);
					}
				}();
				var $temp$p = position,
					$temp$list = commands;
...
var $author$project$Y21D02$Command = F2(
	function (direction, amount) {
		return {z: amount, a9: direction};
	});
var $author$project$Y21D02$Down = 0;
var $author$project$Y21D02$Forward = 1;
...
var $author$project$Y21D02$parse = function (input) {
	return A2(
		...
		A2(
			...
			A2(
				$elm$regex$Regex$find,
				$author$project$Util$regex('(down|forward|up) ([1-9])'),
				input)));
};
var $author$project$Y21D02$start = A3($author$project$Y21D02$Position, 0, 0, 0);
var $author$project$Y21D02$answer = F2(
	function (part, input) {
		var commands = $author$project$Y21D02$parse(input);
		return (part === 1) ? $author$project$Y21D02$multiply(
...
var $author$project$Main$getAnswer = F3(
	function (model, part, data) {
		...
		switch (_v0) {
			...
			case 2021:
				return A3($author$project$Y21$answer, model.b, part, data);
			default:
				return '';
		}
	});
var $author$project$Ports$getRuby = _Platform_outgoingPort(
	'getRuby',
	$elm$json$Json$Encode$list($elm$json$Json$Encode$int));
var $author$project$Main$getRuby = F2(
	function (model, part) {
		return $author$project$Ports$getRuby(
			_List_fromArray(
				[model.a, model.b, part]));
	});
var $author$project$Main$gotAnswer = F3(
	function (part, answer, model) {
		var _v0 = model.aa;
		var answer1 = _v0.a;
		var answer2 = _v0.b;
...
var $author$project$Main$useRuby = F3(
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 3:
				var part = msg.a;
				return A3($author$project$Main$useRuby, model.a, model.b, part) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							X: $author$project$Main$thinking(part)
						}),
					A2($author$project$Main$getRuby, model, part)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							X: $author$project$Main$thinking(part)
			...
			case 4:
				var part = msg.a;
				var answer = A3($author$project$Main$getAnswer, model, part, model.ad);
				return _Utils_Tuple2(
					A3($author$project$Main$gotAnswer, part, answer, model),
					$elm$core$Platform$Cmd$none);
			case 5:
				var _v1 = msg.a;
				var part = _v1.a;
...
var $author$project$Main$viewAnswer = F2(
	function (model, part) {
		...
		var busy = (part === 1) ? model.X.a : model.X.b;
		var answer = (part === 1) ? model.aa.a : model.aa.b;
		var display = function () {
			if (noSolution) {
				return $elm$html$Html$text(
					A3($author$project$Main$getAnswer, model, part, model.ad));
			} else {
				if (busy) {
					return A2(
						$elm$html$Html$img,
...
var $author$project$Main$elmLink = F3(
	function (prefix, year, day) {
		var shortYear = A2($elm$core$String$right, 2, year);
		var paddedDay = ($elm$core$String$length(day) === 2) ? day : ('0' + day);
		var link = prefix + ('views/pages/aoc/' + (year + ('/Y' + (shortYear + ('D' + (paddedDay + '.elm'))))));
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
...
var $author$project$Main$rubyLink = F3(
	function (prefix, year, day) {
		var link = prefix + ('models/aoc/y' + (year + ('d' + (day + '.rb'))));
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Ruby')
				]));
	});
var $author$project$Util$unique = function (list) {
	var incUnique = F2(
		function (elem, lst) {
			return A2($elm$core$List$member, elem, lst) ? lst : A2($elm$core$List$cons, elem, lst);
		});
	return A3($elm$core$List$foldr, incUnique, _List_Nil, list);
};
var $author$project$Main$codeLinks = function (model) {
	...
	return A2(
		$elm$core$List$map,
		function (b) {
			return b ? A3($author$project$Main$rubyLink, prefix, year, day) : A3($author$project$Main$elmLink, prefix, year, day);
		},
		$author$project$Util$unique(
			A2(
				$elm$core$List$map,
				A2($author$project$Main$useRuby, model.a, model.b),
				_List_fromArray(
					[1, 2]))));
};
...
var $author$project$Main$probLink = function (model) {
	var year = $elm$core$String$fromInt(model.a);
	var day = $elm$core$String$fromInt(model.b);
	var link = 'https://adventofcode.com/' + (year + ('/day/' + day));
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
...
var $author$project$Main$viewLinks = function (model) {
	var links = A2(
		...
		A2(
			...
			$author$project$Main$codeLinks(model)));
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$getNote = F2(
	function (year, day) {
		...
		switch (key) {
			...
			case '2021-14':
				return $elm$core$Maybe$Just('I have to admit needing help for part 2 (link in code).');
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$hr, _List_Nil, _List_Nil),
				$author$project$Main$viewHelp(model.aw),
				A2($elm$html$Html$hr, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
