...
Elm.Share.make = function (_elm) {
   ...
   if (_elm.Share.values) return _elm.Share.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var width = 500;
   var hWidth = width / 2;
   return _elm.Share.values = {_op: _op
                              ,width: width
                              ,height: height
                              ,hWidth: hWidth
                              ,hHeight: hHeight
...
Elm.Vector.make = function (_elm) {
   ...
   if (_elm.Vector.values) return _elm.Vector.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var vLen = function (_p0) {
      var _p1 = _p0;
      return $Basics.sqrt(Math.pow(_p1._0,2) + Math.pow(_p1._1,2));
   };
   var vMul = F2(function (f,_p2) {
      var _p3 = _p2;
      return {ctor: "_Tuple2",_0: f * _p3._0,_1: f * _p3._1};
   });
   var vSub = F2(function (_p5,_p4) {
      var _p6 = _p5;
      var _p7 = _p4;
      return {ctor: "_Tuple2"
             ,_0: _p6._0 - _p7._0
   ...
   return _elm.Vector.values = {_op: _op
                               ,vAdd: vAdd
                               ,vSub: vSub
                               ,vMul: vMul
                               ,vLen: vLen};
...
Elm.Pill = Elm.Pill || {};
Elm.Pill.make = function (_elm) {
   "use strict";
   _elm.Pill = _elm.Pill || {};
   if (_elm.Pill.values) return _elm.Pill.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var outsideArea = function (_p0) {
      var _p1 = _p0;
      var _p3 = _p1._1;
      var _p2 = _p1._0;
      return _U.cmp(_p2,0 - $Share.hWidth) < 0 || (_U.cmp(_p2,
      $Share.hWidth) > 0 || (_U.cmp(_p3,
      0 - $Share.hHeight) < 0 || _U.cmp(_p3,$Share.hHeight) > 0));
   };
   var outOfBounds = function (p) {    return outsideArea(p.pos);};
   var collision = F2(function (p1,p2) {
      return _U.cmp($Vector.vLen(A2($Vector.vSub,p1.pos,p2.pos)),
      p1.rad + p2.rad) < 0;
   });
   var viewPill = function (_p4) {
      var _p5 = _p4;
      return A2($Graphics$Collage.move,
      _p5.pos,
      A2($Graphics$Collage.filled,
      _p5.col,
      $Graphics$Collage.circle(_p5.rad)));
   };
   var updatePill = F2(function (t,p) {
      return _U.update(p,
      {pos: A2($Vector.vAdd,p.pos,A2($Vector.vMul,t,p.vel))});
   });
   var defaultPill = {pos: {ctor: "_Tuple2"
                           ,_0: 0
                           ,_1: $Share.hHeight}
                     ,vel: {ctor: "_Tuple2",_0: 0,_1: 0 - $Share.defPillVel}
                     ,rad: $Share.defPillRad
                     ,col: $Share.defPillCol};
   var newPill = F2(function (x,c) {
      return _U.update(defaultPill,
      {pos: {ctor: "_Tuple2",_0: x,_1: $Share.hHeight},col: c});
   });
   var Pill = F4(function (a,b,c,d) {
      return {pos: a,vel: b,rad: c,col: d};
   });
   return _elm.Pill.values = {_op: _op
                             ,Pill: Pill
...
Elm.Player.make = function (_elm) {
   ...
   var _op = {};
   var center = function (_p0) {
      var _p1 = _p0;
      return {ctor: "_Tuple2",_0: _p1._0 / 2 | 0,_1: _p1._1 / 2 | 0};
   };
   var relative = F2(function (_p3,_p2) {
      var _p4 = _p3;
      var _p5 = _p2;
      return {ctor: "_Tuple2"
             ,_0: _p5._0 - _p4._0
   ...
   var mouseSignal = function (delta) {
      ...
      A3($Signal.map2,
      relative,
      A2($Signal.map,center,$Window.dimensions),
      $Mouse.position));
   };
   var updatePlayer = F2(function (_p6,p) {
      var _p7 = _p6;
      return _U.update(p,
      {pos: {ctor: "_Tuple2"
            ,_0: $Basics.toFloat(_p7._0)
            ,_1: $Basics.toFloat(_p7._1)}});
   });
   var defaultPlayer = _U.update($Pill.defaultPill,
   {col: $Share.defPlayerCol
   ,pos: {ctor: "_Tuple2"
         ,_0: 0
...
Elm.Game.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var textForm = F3(function (lineNo,textScale,str) {
      return A2($Graphics$Collage.move,
      {ctor: "_Tuple2"
      ,_0: 0
      ,_1: $Basics.toFloat(lineNo) * $Share.lineHeight},
   ...
   var viewGameTexts = function (g) {
      var _p0 = g.state;
      switch (_p0.ctor)
      {case "Init": return _U.list([A3(textForm,3,3,"Blue PiLL")
                                   ,A3(textForm,1,2,"Collect blue pills")
                                   ,A3(textForm,0,2,"Avoid red pills")
                                   ,A3(textForm,-1,2,"Stay inside the square")
                                   ,A3(textForm,-2,2,"Click to start")
                                   ,A3(textForm,-3,1,"Acknowledgements to Goran Milovanovic")]);
         case "Over": return _U.list([A3(textForm,2,3,"Game Over")
                                     ,A3(textForm,
                                     1,
                                     2,
                                     A2($Basics._op["++"],"Score: ",$Basics.toString(g.score)))
                                     ,A3(textForm,
                                     0,
                                     2,
                                     A2($Basics._op["++"],
                                     ...
                                     ,A3(textForm,-1,2,"Click to restart")]);
         default: return _U.list([A3(textForm,
           0,
           3.0,
   ...
   var Game = F6(function (a,b,c,d,e,f) {
      return {maxScore: a
             ,player: b
             ,pills: c
             ,seed: d
   ...
   var Play = {ctor: "Play"};
   var Init = {ctor: "Init"};
   var defaultGame = {maxScore: 0
                     ,player: $Player.defaultPlayer
                     ,pills: _U.list([])
                     ,seed: $Random.initialSeed(12345)
                     ,score: 0
                     ,state: Init};
   var updatePlay = F2(function (event,g) {
      var _p2 = event;
      switch (_p2.ctor)
      {case "Tick": var outside = $Pill.outsideArea({ctor: "_Tuple2"
                                                    ,_0: $Basics.toFloat(_p2._0._1._0)
                                                    ,_1: $Basics.toFloat(_p2._0._1._1)});
           var unculled = A2($List.filter,
           function (_p3) {
              return $Basics.not($Pill.outOfBounds(_p3));
           },
           g.pills);
           var untouched = A2($List.filter,
           function (_p4) {
              return $Basics.not(A2($Pill.collision,g.player,_p4));
           },
           unculled);
           var hit = function (c) {
              return A2($List.filter,
              function (p) {
                 return _U.eq(p.col,c) && A2($Pill.collision,g.player,p);
              },
              unculled);
           };
           var captured = hit($Share.capturePillCol);
           var collided = hit($Share.defPillCol);
           return $List.isEmpty(collided) && $Basics.not(outside) ? _U.update(g,
           {pills: A2($List.map,$Pill.updatePill(_p2._0._0),untouched)
           ,player: A2($Player.updatePlayer,_p2._0._1,g.player)
           ,score: g.score + $List.length(captured)}) : _U.update(defaultGame,
           {maxScore: A2($Basics.max,g.maxScore,g.score)
           ,player: $Player.defaultPlayer
           ,score: g.score
           ,seed: g.seed
           ,state: Over});
         case "Add": var _p5 = A2($Random.generate,
           A2($Random.$float,
           ...
           var x = _p5._0;
           var seed$ = _p5._1;
           var _p6 = A2($Random.generate,A2($Random.$float,0,1),seed$);
           var p = _p6._0;
           var seed$$ = _p6._1;
           var c = _U.cmp(p,
           $Share.capturePillProb) < 0 ? $Share.capturePillCol : $Share.defPillCol;
           return _U.update(g,
           {pills: A2($List._op["::"],A2($Pill.newPill,x,c),g.pills)
           ,seed: seed$$});
         default: return g;}
   });
   var updateGame = F2(function (event,g) {
      var _p7 = g.state;
      if (_p7.ctor === "Play") {
            return A2(updatePlay,event,g);
         } else {
            return click(event) ? _U.update(defaultGame,
            {seed: g.seed,maxScore: g.maxScore,state: Play}) : g;
         }
   });
...
Elm.Main.make = function (_elm) {
   ...
   A2($Signal.map,$Time.inSeconds,delta),
   $Player.mouseSignal(delta));
   var events = $Signal.mergeMany(_U.list([A2($Signal.map,
                                          $Game.Tick,
                                          input)
                                          ,A2($Signal.map,
                                          $Basics.always($Game.Add),
                                          $Time.every($Time.second * $Share.spawnInterval))
                                          ,A2($Signal.map,$Basics.always($Game.Click),$Mouse.clicks)]));
   var render = F2(function (_p0,g) {
      var _p1 = _p0;
      var texts = $Game.viewGameTexts(g);
      var pills = A2($List.map,$Pill.viewPill,g.pills);
      ...
      $Share.width,
      $Share.height,
      A2($Basics._op["++"],A2($List._op["::"],player,pills),texts))));
   });
   var main = A3($Signal.map2,
   render,
   $Window.dimensions,
   A3($Signal.foldp,$Game.updateGame,$Game.defaultGame,events));
