...
var $author$project$Main$initModel = {v: _List_Nil, G: 10, C: false};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			var num = $author$project$Main$nextNumber(model.G);
			var newModel = _Utils_update(
				model,
				{
					v: A2($elm$core$List$cons, num, model.v),
					G: num + 1,
					C: false
				});
...
var $author$project$Main$viewButtonRow = function (model) {
	...
	var display = ($elm$core$List$length(model.v) >= 5) ? 'none' : 'table-row';
