...
view m =
    div [ class "row" ]
        ...
        , div [ class "col" ]
            [ div [ class "float-end" ]
                [ button [ class "btn btn-primary btn-sm ms-1", onClick DniIncrement ] [ text <| "+" ++ String.fromInt m.increment ]
                , button [ class "btn btn-warning btn-sm ms-1", onClick DniCycle ] [ text "×" ]
                , button [ class "btn btn-danger btn-sm ms-1", onClick DniDecrement ] [ text <| "-" ++ String.fromInt m.increment ]
                ]
            ]
        ]
